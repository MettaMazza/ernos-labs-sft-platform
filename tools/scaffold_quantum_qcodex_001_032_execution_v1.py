...
from sft.quantum_computation.qcodex_001_032_laws_v1 import IDS
def main():
    for claim_id in IDS:
        path = ROOT / "claims" / claim_id / "execution.py"
        if path.exists(): raise SystemExit("QCODEX execution entrypoint already exists: " + claim_id)
    ...
    print(f"created {len(IDS)} QCODEX execution entrypoints")
