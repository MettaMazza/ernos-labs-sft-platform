#!/usr/bin/env python3
"""Capture the complete pre-registered KIN-013 source surface."""
...
def main() -> None:
    ...
    if specification.get("target_values_or_hashes_present") is not False:
        raise SystemExit("KIN-013 prefetch specification is not value-free")
    ...
    inventory = {
        "schema": "sft-v3-reaction-dynamics-scattering-source-inventory/1",
