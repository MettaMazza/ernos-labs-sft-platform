"""Execute, admit and materialize all quantum-computation claims."""
...
def load_execution(claim_id: str):
    ...
    definition = importlib.util.spec_from_file_location("sft_quantum_admission_" + claim_id.replace("-", "_"), path)
