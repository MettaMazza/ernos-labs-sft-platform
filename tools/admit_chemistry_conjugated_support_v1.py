...
def load_execution():
    path = ROOT / "claims" / CONJUGATED_SUPPORT_SPEC.claim_id / "execution.py"
    spec = importlib.util.spec_from_file_location("org001_execution", path)
...
def main() -> None:
    ...
    certificate = {
        "claim_id": spec.claim_id,
        "chemistry_obligation": "SFT-CHEM-OBL-ORG-001",
        ...
        **analysis,
        ...
        "external_definition_structure_coordinate_vibration_or_spectrum_used_to_select_survivor": False,
        "external_signed_control_inscription_used_as_native_arithmetic": False,
    ...
    (package / "STATUS.md").write_text(
        ...
        "- Exact finite connected alternating support from the two held Fold fibres with depth-independent successor.\n"
        "- External vector: ten rows across seven sources, complete experimental structure/vibration surfaces and all 502 UV-visible points.\n"
        "- Preserved adverse evidence: one V1 parser overrun, corrected separately in V2 without source recapture.\n"
