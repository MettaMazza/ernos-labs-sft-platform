"""Project an admitted claim using the exact versioned execution named in its manifest."""
...
def load_execution(execution_path: Path):
    specification = importlib.util.spec_from_file_location(
        "sft_versioned_evidence_materialization", execution_path
    )
...
def main() -> None:
    ...
    execution_path = ROOT / args.execution_file
    if execution_path.parent != package:
        raise RuntimeError("versioned execution must belong to the claim package")
