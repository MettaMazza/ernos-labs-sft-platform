#!/usr/bin/env python3
"""Create the six mechanical HAND execution entry points."""
import sys
...
def main():
    for claim_id in IDS:
        ...
        if path.exists():
            raise SystemExit("HAND execution entry already exists: " + claim_id)
    ...
    print(f"created {len(IDS)} HAND execution entry points")
