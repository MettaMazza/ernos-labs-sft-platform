#!/usr/bin/env python3
"""Create all SUST claim and experiment packages from frozen specifications."""
...
from sft.materials.sust_001_009_external_v1 import experiment_registration
from sft.materials.sust_001_009_laws_v1 import ORDER, SPECS
from sft.physics.structural_constants import completeness_record, survivor_id

REGISTRY_ID = "sha256:d1d11eadf87cb07c90143d4b872b57cc80480b2ff0dbfac4db682ce77b0be1b7"
VECTOR_ID = "sha256:cddfb49ff5eeeeacc13d2758847b89f98e7c0f82730ff7318e597ec6989fe81b"
...
def main():
    for claim_id in ORDER:
        ...
        write(package / "registration.json", {
            ...
            "branch": "materials",
            "subbranch": "sustainable_material_cycles_lifecycle_complete_custody",
            "claim_id": claim_id,
            "title": spec.title,
            ...
            "pre_source_target_registry": "census/materials_sust_001_009_target_registry_v1.json",
        ...
        write(experiment / "registration.json", {
            ...
            "schema": "sft-v3-materials-sust-experiment-registration/1",
            **experiment_registration(spec),
            ...
            "target_registry": "census/materials_sust_001_009_target_registry_v1.json",
            "source_custody_manifest": "experiments/external_sources/materials/sust_001_009_v1/source_custody_manifest.json",
            "complete_evidence_vector": "experiments/external_sources/materials/sust_001_009_v1/complete_evidence_vector_v1.json",
    ...
    print("scaffolded", len(ORDER), "SUST packages")
