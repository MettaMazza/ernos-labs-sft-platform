#!/usr/bin/env python3
"""Admit and materialize all post-seal vacuum validation claims."""
...
def load_execution(claim_id: str):
    ...
    definition = importlib.util.spec_from_file_location("sft_vacuum_validation_" + claim_id.replace("-", "_"), path)
