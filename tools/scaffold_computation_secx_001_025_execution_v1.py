#!/usr/bin/env python3
"""Create the twenty-five mechanical SECX execution entry points."""
import sys
...
def main():
    for claim_id in IDS:
        ...
        if path.exists():
            raise SystemExit("SECX execution entry already exists: " + claim_id)
    ...
    print(f"created {len(IDS)} SECX execution entry points")
