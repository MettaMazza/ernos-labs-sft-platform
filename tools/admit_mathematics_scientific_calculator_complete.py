#!/usr/bin/env python3
"""Admit and materialize complete scientific calculator claim 006 only."""
...
from sft.mathematics.calculator_complete.law import SPEC  # noqa: E402
...
def load_execution():
    ...
    definition = importlib.util.spec_from_file_location("sft_math_calculator_complete_admission", path)
    if definition is None or definition.loader is None:
        raise RuntimeError("cannot load complete calculator execution")
...
def registration() -> dict[str, object]:
    return {
        ...
        "candidate_grammar": {
            ...
            "completeness_certificate": "generated by the frozen engine from the complete ten-coordinate product",
        ...
        "intended_certificate": (
            "Complete 1,024-form extension census; exact operation, interaction, current Mathematics-family, proof-output, "
            "portability, resource and complete-coverage witnesses; four adverse controls; independent product regeneration, "
            "operational execution and coverage replay."
        ),
        ...
        "extends": "SFT-MATH-SCIENTIFIC-CALCULATOR-005",
        "title": SPEC.title,
    }
    ...
    (package / "STATUS.md").write_text(
        "\n".join(
            (
                ...
                "Status: `independently_replicated`",
                "",
                "- Familiar calculator-first desktop app with progressively disclosed SFT proof.",
                "- Complete declared scientific expression language and current 24-family Mathematics predecessor census.",
                "- Exact JSON evidence explicitly distinguished from an engine admission.",
                "- macOS, Windows and Linux launch paths; Python standard-library runtime only.",
                "- Declared active implementation: 100% statements and 100% branches.",
