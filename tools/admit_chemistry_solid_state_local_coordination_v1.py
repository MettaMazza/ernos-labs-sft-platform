...
from sft.chemistry.solid_state_local_coordination_batch_v1 import (  # noqa: E402
    PRIMARY_PATH,
    SOLID_STATE_LOCAL_COORDINATION_SPEC,
)
from sft.chemistry.solid_state_local_coordination_validation_v1 import (  # noqa: E402
    _source_rows,
    exact_analysis,
)
...
def load_execution():
    path = ROOT / "claims" / SOLID_STATE_LOCAL_COORDINATION_SPEC.claim_id / "execution.py"
...
def main() -> None:
    spec = SOLID_STATE_LOCAL_COORDINATION_SPEC
    ...
    certificate = {
        "claim_id": spec.claim_id,
        "chemistry_obligation": "SFT-CHEM-OBL-INORG-015",
        ...
        **analysis,
        ...
        "observed_coordination_network_or_mixed_crystal_outcome_used_to_select_survivor": False,
    ...
    (package / "STATUS.md").write_text(
        ...
        "- Exact primitive local formula, generated repeat rank one through three, and Chemistry-to-Materials handoff.\n"
        "- External vector: ten rows from two complete IUPAC records, including one preserved returned-identity mismatch.\n"
