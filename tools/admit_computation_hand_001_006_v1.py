#!/usr/bin/env python3
"""Admit the complete HAND-001 through HAND-006 family sequentially."""
...
from sft.computation.hand_001_006_laws_v1 import IDS, SPECS
...
def seals():
    for tool, status in (("verify_engine_seal.py", "VALID_CANONICAL_ENGINE"), ("verify_verification_authority_seal.py", "VALID_CANONICAL_VERIFICATION_AUTHORITY")):
        ...
        if result.returncode or data.get("status") != status:
            raise SystemExit("Classical Computation HAND admission halted: protected seal invalid")
...
def main():
    ...
    for index, claim_id in enumerate(IDS, 1):
        ...
        certificate = {
            "claim_id": claim_id,
            "classical_computation_obligation": f"SFT-COMP-OBL-HAND-{index:03d}",
        ...
        payload = {
            ...
            "registration.json": {
                ...
                "pre_source_target_registry": "census/computation_hand_001_006_target_registry_v1.json",
                "empirical_protocol": "post-registry exact handoff execution custody",
