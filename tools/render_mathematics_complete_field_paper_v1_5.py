#!/usr/bin/env python3
"""Render the unpublished complete-field Mathematics v1.5 paper."""
...
SOURCE = ROOT / "publications/successors/mathematics/FROM_FOLD_TO_MATHEMATICS_PAPER_001_V1_5.md"
OUTPUT = ROOT / "output/pdf/from-fold-to-mathematics-branch-paper-001-v1.5.pdf"


def doi() -> str:
    return "Version 1.5 DOI pending archival deposit"
...
def cover():
    ...
    return [
        ...
        Spacer(1, 17 * mm),
        Paragraph(
            "Third clean-room reconstruction - complete-field Mathematics"
            "<br/>323 of 323 frozen obligations - 24 complete families"
            "<br/>97,280 generated candidates - 323 unique survivors - 1,292 controls"
...
def main() -> None:
    ...
    document = BaseDocTemplate(
        ...
        author="Maria Smith",
        subject="Complete-field Smithian Fold Theory Mathematics branch, version 1.5",
