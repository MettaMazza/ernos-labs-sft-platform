#!/usr/bin/env python3
"""Admit and materialize post-seal matter/flavour validations."""
...
from sft.physics.matter_flavour_validation_v1 import VALIDATION_SPECS  # noqa: E402


def load_execution(claim_id: str):
    path = ROOT / "claims" / claim_id / "execution.py"
    definition = importlib.util.spec_from_file_location("sft_matter_validation_" + claim_id.replace("-", "_"), path)
