#!/usr/bin/env python3
"""Admit and materialize post-seal Physics precision validations."""
...
def load_execution(claim_id: str):
    ...
    definition = importlib.util.spec_from_file_location("sft_precision_validation_" + claim_id.replace("-", "_"), path)
