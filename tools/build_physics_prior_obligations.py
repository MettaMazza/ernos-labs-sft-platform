...
V1_CLAIM_OVERRIDES: dict[str, tuple[str, ...]] = {
    ...
    "D9m": ("SFT-PHYS-GRAVITY-NONLINEAR-SELF-SOURCE-003", "SFT-PHYS-POST-NEWTONIAN-FIXED-POINT-TERMINAL-009"),
    "D9n": ("SFT-PHYS-GRAVITY-GRAVITON-POLARIZATION-003", "SFT-PHYS-SYMMETRIC-SOURCE-CONSERVATION-TERMINAL-010"),
    "D9o": ("SFT-PHYS-GRAVITY-WEAK-FIELD-FLUX-003", "SFT-PHYS-GRAVITY-STATIC-CLOCK-003", "SFT-PHYS-GRAVITY-STRONG-FIELD-HORIZON-003", "SFT-PHYS-STATIC-EXTERIOR-CLOCK-TERMINAL-011"),
    "D9q": ("SFT-PHYS-GRAVITY-WAVE-QUADRUPOLE-003", "SFT-PHYS-QUADRUPOLE-RADIATED-POWER-TERMINAL-012"),
    "D10e": ("SFT-PHYS-STRONG-RUNNING-DIRECTION-002", "SFT-PHYS-POST-NEWTONIAN-FIXED-POINT-TERMINAL-009", "SFT-PHYS-FIELD-SOURCE-RESPONSE-001", "SFT-PHYS-STRONG-CARRIER-MASSLESS-CONFINED-TERMINAL-013", "SFT-PHYS-STRONG-FIELD-NONLINEAR-FIXED-POINT-TERMINAL-014"),
    "D10f": ("SFT-PHYS-FORCE-COMPLETE-SECTOR-INVENTORY-003", "SFT-PHYS-STRONG-RUNNING-DIRECTION-002", "SFT-PHYS-SPACETIME-EXACT-INTERVAL-003", "SFT-PHYS-WAVE-EXACT-OPERATIONS-003", "SFT-PHYS-MATTER-COMPOSITE-HADRONS-001", "SFT-PHYS-STRONG-CARRIER-MASSLESS-CONFINED-TERMINAL-013"),
    ...
    "B9": ("SFT-PHYS-STRONG-RUNNING-DIRECTION-002", "SFT-MATH-EXACT-RELATIONS-002", "SFT-MATH-SELF-SIMILAR-CONVERGENCE-002", "SFT-PHYS-COUPLING-RUNNING-CONVERGENCE-TERMINAL-006"),
    ...
    "E4": ("SFT-PHYS-COUPLED-ENSEMBLE-SYNCHRONIZATION-TERMINAL-007",),
...
V2_CLAIM_OVERRIDES: dict[int, tuple[str, ...]] = {
    ...
    90: ("SFT-PHYS-MATTER-DECAY-001", "SFT-PHYS-DECAY-WIDTH-BRANCHING-LIFETIME-TERMINAL-006"),
    ...
    185: ("SFT-PHYS-COUPLED-ENSEMBLE-SYNCHRONIZATION-TERMINAL-007", "SFT-PHYS-COUPLED-MAP-CRITICALITY-TERMINAL-008"),
    189: ("SFT-PHYS-SPACE-DIMENSION-THREE-001", "SFT-PHYS-ORBITAL-DIMENSION-STABILITY-TERMINAL-009"),
    190: ("SFT-FOUNDATION-HALF-ONE-001", "SFT-PHYS-SPACE-BOUNDARY-RANK-TWO-001", "SFT-PHYS-GRAVITY-GRAVITON-POLARIZATION-003", "SFT-PHYS-SYMMETRIC-SOURCE-CONSERVATION-TERMINAL-010"),
    ...
    241: ("SFT-PHYS-DYNAMICS-FREE-PHASE-DISPERSION-003", "SFT-PHYS-STRONG-CARRIER-MASSLESS-CONFINED-TERMINAL-013"),
    251: ("SFT-FOUNDATION-FOLD-DYNAMICS-001", "SFT-PHYS-ATOMIC-TRANSITION-SELECTION-004", "SFT-PHYS-ATOMIC-FIELD-SPLITTING-TERMINAL-005"),
...
REVIEWED_OPEN_V1: dict[str, dict[str, str]] = {
    ...
    "D9m": {
        "formal_same_strength_status": "closed_at_declared_boundary",
        "empirical_boundary_status": "closed_at_declared_boundary",
        "remaining_work": "none; binary support, generator-three colour, half-One coupling and positive quadratic field feedback force the exact scalar map f-next=(One/2)(7/16+f^2), its sole admissible Fold-part fixed point One/4 and depth-independent contraction of every positive error and added correction. The complete V1 vector, V2 map and primary weak-field nonlinear hierarchy open only post-seal; external formal iteration is retained without being inflated into universal numerical convergence outside the registered Fold scalar channel.",
    },
    "D9n": {
        "formal_same_strength_status": "closed_at_declared_boundary",
        "empirical_boundary_status": "closed_at_declared_boundary",
        "remaining_work": "none; four generated coordinate labels force ten symmetric componentwise curvature-source pairs partitioned into one energy, three momentum and six stress carriers. Commuting held-coordinate shifts force four depth-independent 48-to-48 local conservation ledgers, while deletion of one flow term fails. Complete continuum, exact-discrete and GW rows open only post-seal, with nonlinear Regge and pure-mode measurement limitations retained rather than conflated with the V3 operator.",
    },
    "D9o": {
        "formal_same_strength_status": "closed_at_declared_boundary",
        "empirical_boundary_status": "closed_at_declared_boundary",
        "remaining_work": "none; doubled positive mass fixes the horizon boundary, rank-two conservation forces field equal to boundary/radius-squared and well equal to boundary/radius, and the positive One-complement uniquely forces the exterior clock-square coefficient. Every finite outward successor preserves flux and approaches the One without completed infinity; exact-square clocks force the farther-faster direction. The complete primary exterior solution and NIST/JILA gradients open only post-seal, with physical-unit and measurement-scope limits retained.",
    },
    "D9q": {
        "formal_same_strength_status": "closed_at_declared_boundary",
        "empirical_boundary_status": "closed_at_declared_boundary",
        "remaining_work": "none; held source and momentum records leave the quadrupole first, its third generated difference is the radiative rate, the admitted field-energy square and half-One coupling force total power, static support is structurally empty, amplitude scaling is exactly squared and rank-two shell dilution preserves power at every positive depth. The complete primary Double Pulsar paper opens only post-seal; all timing corrections, exact normalized agreement, uncertainty, equation-of-state rerun and regime limits are retained without importing external signs or decimals into the proof.",
    },
    "D10e": {
        "formal_same_strength_status": "closed_at_declared_boundary",
        "empirical_boundary_status": "closed_at_declared_boundary",
        "remaining_work": "none; the exact three-way census separates chargeless held source, gravitational quarter-One contraction and colour self-source persistence. Every strong successor retains F and appends the complete binary carrier, so the correction remains exact two, no positive exact finite fixed point exists, and every positive exact finite bound has a generated finite witness above it without completed infinity. Complete PDG and lattice-QCD sources open only post-seal; non-abelian self-interaction and the linear unbroken string branch agree, while dynamical pair creation, full-QCD ground-state saturation, uncertainties and single-ensemble/nonphysical-mass limits are retained explicitly.",
    },
    "D10f": {
        "formal_same_strength_status": "closed_at_declared_boundary",
        "empirical_boundary_status": "closed_at_declared_boundary",
        "remaining_work": "none; three colour labels force eight non-singlet carriers, empty mass and rest-capture force local One-speed propagation, and colour self-source forces a fixed half-One tube whose work grows by exact two-thirds at every separation successor and exceeds every positive exact finite bound. The complete PDG sources open only post-seal; the m=0 theoretical classification, few-MeV caveat, absence of free coloured states, measured colour factors and confinement scope are all retained without fitting or target selection.",
    },
    "D11a": {
        "formal_same_strength_status": "versioned_successor_required",
        "empirical_boundary_status": "required_open",
...
RECENTLY_VERIFIED_V1 = {
    ...
    "N1", "N3", "N4", "N6", "T1", "T2", "B2", "V-7", "V-8", "VI-1", "VI-2", "VI-3", "E3", "E4", "PH2", "PH3", "D9f", "D9m", "D9n", "D9o", "D9q", "D10e", "D10f", "B9",
    "B6", "B12-R",
...
RECENTLY_VERIFIED_V2 = {
    ...
    28, 60, 64, 66, 90, 96, 122, 141, 142, 185, 189, 190, 208, 241, 251,
}
