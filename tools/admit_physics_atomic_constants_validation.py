"""Admit and materialize post-seal atomic-constant validation claims."""
...
def load_execution(claim_id: str):
    ...
    definition = importlib.util.spec_from_file_location("sft_atomic_validation_" + claim_id.replace("-", "_"), path)
