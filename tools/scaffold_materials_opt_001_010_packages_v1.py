#!/usr/bin/env python3
"""Create registered OPT claim and experiment packages from frozen specifications."""
import json
...
from sft.materials.opt_001_010_external_v1 import experiment_registration
from sft.materials.opt_001_010_laws_v1 import ORDER, SPECS
from sft.physics.structural_constants import completeness_record, survivor_id

REGISTRY_ID = "sha256:f0e4c811c7871b07a57973b232ff78269797c37894af88cab83cc59ec52e4a77"
VECTOR_ID = "sha256:644deb845d38c749f205cf4d9355e1314e986523fe3bd97d7159076b9b11f99e"
...
def main():
    for claim_id in ORDER:
        ...
        write(package / "registration.json", {
            ...
            "branch": "materials",
            "subbranch": "optics_photonics_polarization_electromagnetic_materials",
            "claim_id": claim_id,
            "title": spec.title,
            ...
            "pre_source_target_registry": "census/materials_opt_001_010_target_registry_v1.json",
        ...
        write(experiment / "registration.json", {
            ...
            "schema": "sft-v3-materials-opt-experiment-registration/1",
            **experiment_registration(spec),
            ...
            "target_registry": "census/materials_opt_001_010_target_registry_v1.json",
            "source_custody_manifest": "experiments/external_sources/materials/opt_001_010_v1/source_custody_manifest.json",
            "source_addendum_registry": "census/materials_opt_003_quantum_yield_source_addendum_v1.json",
            "source_addendum_manifest": "experiments/external_sources/materials/opt_001_010_v1/opt_003_quantum_yield_source_addendum_v1.json",
            "complete_evidence_vector": "experiments/external_sources/materials/opt_001_010_v1/complete_evidence_vector_v1.json",
    ...
    print("scaffolded", len(ORDER), "OPT packages")
