#!/usr/bin/env python3
"""Reconcile the complete admitted HAND family against the frozen census."""
import hashlib
import json
...
PREVIOUS = ROOT / "census/computation_discipline_current_reconciliation_v11.json"
OUT = ROOT / "census/computation_discipline_current_reconciliation_v12.json"
AUDIT = ROOT / "audits/COMPUTATION_HAND_001_025_COMPLETION_2026-07-29.json"
...
def main():
    ...
    if canonical(body) != previous_identity or previous["current_closed_count"] != 363:
    ...
    registry = json.loads((ROOT / "census/computation_hand_001_006_target_registry_v1.json").read_text())
    rows = []
    ...
    completed["HAND"] = rows
    value = {
        "schema": "sft-v3-classical-computation-discipline-current-reconciliation/12",
        "date": "2026-07-29",
        ...
        "current_closed_count": 369,
        "current_open_count": 0,
        "current_completion_fraction": "369/369",
    ...
    audit = {
        "schema": "sft-v3-classical-computation-hand-completion/1",
        "date": "2026-07-29",
        "family": "HAND",
        "family_completion": "6/6",
        "generated_candidate_count": 6 * 256,
        "unique_survivor_count": 25,
        "passed_control_count": 6 * 4,
        "post_registry_exact_observation_count": 25,
        "implementation_distinct_reconstruction_count": 25,
        "exact_receipt_replay": "6/6",
        "receipt_rows": rows,
        "protected_engine_or_verifier_changed": False,
        "current_classical_computation_progress": "369/369",
        "current_classical_computation_percent": "100.0%",
        "frozen_census_identity": frozen_identity,
        "reconciliation_identity": value["reconciliation_identity"],
    }
    AUDIT.write_text(json.dumps(audit, indent=2, sort_keys=True) + "\n")
    print(json.dumps({"family": "6/6", "candidates": 6 * 256, "controls": 6 * 4, "current": "369/369", "percent": "100.0%", "identity": value["reconciliation_identity"]}, indent=2))
