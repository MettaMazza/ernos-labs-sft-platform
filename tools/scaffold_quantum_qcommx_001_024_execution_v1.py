...
from sft.quantum_computation.qcommx_001_024_laws_v1 import IDS
def main():
    for claim_id in IDS:
        path = ROOT / "claims" / claim_id / "execution.py"
        if path.exists(): raise SystemExit("QCOMMX execution entrypoint already exists: " + claim_id)
    ...
    print(f"created {len(IDS)} QCOMMX execution entrypoints")
