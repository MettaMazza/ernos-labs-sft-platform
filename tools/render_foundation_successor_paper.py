#!/usr/bin/env python3
"""Render Foundation Branch Paper 001 version 1.2 to archival PDF."""
...
SOURCE = ROOT / "publications/successors/foundation/FROM_NOTHING_TO_FOLD_FOUNDATION_PAPER_001_V1_2.md"
OUTPUT = ROOT / "output/pdf/from-nothing-to-fold-foundation-branch-paper-001-v1.2.pdf"
...
def draw_page(canvas, doc):
    ...
    if doc.page > 1:
        ...
        canvas.drawString(20 * mm, height - 11.8 * mm, "FROM NOTHING TO FOLD - FOUNDATION BRANCH PAPER 001 - VERSION 1.2")
...
def cover_story():
    ...
    return [
        Spacer(1, 27 * mm),
        Paragraph("SMITHIAN FOLD THEORY - FOUNDATION BRANCH PAPER 001 - VERSION 1.2", kicker),
        ...
        Spacer(1, 18 * mm),
        Paragraph("Third clean-room reconstruction - expanded Foundation patch<br/>16 admitted theorems - 5,222 generated candidate classes - 32/32 prior obligations closed<br/>Version 1.2.0 - 26 July 2026 - DOI: 10.5281/zenodo.21591169<br/>Paper: CC BY 4.0 - Code: Apache-2.0", note),
    ]
