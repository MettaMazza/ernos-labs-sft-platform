#!/usr/bin/env python3
"""Render the standalone Information Science branch paper to archival PDF."""
...
def draw_page(canvas, doc):
    ...
    if doc.page > 1:
        ...
        canvas.drawString(
            20 * mm,
            height - 11.8 * mm,
            "FROM DISTINCTION TO INFORMATION - ERNOS LABS INFORMATION SCIENCE BRANCH PAPER 001",
        )
...
def cover():
    ...
    return [
        ...
        Paragraph("From Distinction to Information", title),
        Spacer(1, 8 * mm),
        Paragraph(
            "An Exact, Parameter-Free and Machine-Closed Derivation of "
            "Information Science from Smithian Fold Theory",
            subtitle,
        ),
        Spacer(1, 11 * mm),
        Table(
        ...
        Spacer(1, 15 * mm),
        Paragraph(
            "Third clean-room reconstruction - complete dated Information Science field"
            "<br/>262 admitted derivations - 75,776 generated candidate structures"
            "<br/>1,048 adverse controls - 262 independent reconstructions"
...
def main() -> None:
    ...
    document = BaseDocTemplate(
        ...
        topMargin=21 * mm,
        bottomMargin=18 * mm,
        title="From Distinction to Information",
        author="Maria Smith",
        subject="Completed Smithian Fold Theory Information Science branch",
