#!/usr/bin/env python3
"""Create all PROC claim and experiment packages from frozen specifications."""
...
from sft.materials.proc_001_010_external_v1 import experiment_registration
from sft.materials.proc_001_010_laws_v1 import ORDER, SPECS
from sft.physics.structural_constants import completeness_record, survivor_id

REGISTRY_ID = "sha256:174bb9680dfd9e39f6c7a7075a89b4490b0ca651faddf7a60e74095b0d867ead"
VECTOR_ID = "sha256:9a2948293f4a07eace752856af116ee084599909216177e60f9fd2d084400f25"
...
def main():
    for claim_id in ORDER:
        ...
        write(package / "registration.json", {
            ...
            "branch": "materials",
            "subbranch": "processing_solidification_sintering_heat_treatment_additive",
            "claim_id": claim_id,
            "title": spec.title,
            ...
            "pre_source_target_registry": "census/materials_proc_001_010_target_registry_v1.json",
        ...
        write(experiment / "registration.json", {
            ...
            "schema": "sft-v3-materials-proc-experiment-registration/1",
            **experiment_registration(spec),
            ...
            "target_registry": "census/materials_proc_001_010_target_registry_v1.json",
            "source_custody_manifest": "experiments/external_sources/materials/proc_001_010_v1/source_custody_manifest.json",
            "complete_evidence_vector": "experiments/external_sources/materials/proc_001_010_v1/complete_evidence_vector_v1.json",
    ...
    print("scaffolded", len(ORDER), "PROC packages")
