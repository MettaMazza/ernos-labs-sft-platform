"""Materialize the pre-source-sealed stereochemistry/organic/polymer batch."""
...
from sft.chemistry.stereochemistry_organic_polymer_batch_1 import (  # noqa:E402
...
def build_execution(root: Path) -> ClaimExecution:
 spec=next(x for x in STEREOCHEMISTRY_ORGANIC_POLYMER_BATCH_1_SPECS if x.claim_id=={spec.claim_id!r})
 source_files=(root/"sft/chemistry/generated_law.py",root/"sft/chemistry/generated_multi_source_law.py",root/"sft/chemistry/stereochemistry_organic_polymer_derivation.py",root/"sft/chemistry/stereochemistry_organic_polymer_batch_1.py",root/"experiments/sealed_predictions/chemistry_stereochemistry_organic_polymer_batch_1_pre_source.json",root/"claims/{spec.claim_id}/execution.py",root/"sft/physics/generated_empirical_law.py",root/"sft/engine/fold_language.py",root/"sft/engine/custody.py",root/"sft/engine/hostile.py",root/"sft/engine/isolation.py",root/"sft/engine/empirical.py")
...
def main() -> None:
    ...
    for spec in STEREOCHEMISTRY_ORGANIC_POLYMER_BATCH_1_SPECS:
        ...
        registration["pre_source_derivation_seal"] = "experiments/sealed_predictions/chemistry_stereochemistry_organic_polymer_batch_1_pre_source.json"
        ...
        record["pre_source_derivation_seal"] = "experiments/sealed_predictions/chemistry_stereochemistry_organic_polymer_batch_1_pre_source.json"
        record["authority_support_registry"] = "experiments/external_sources/chemistry/observations_stereochemistry_organic_polymer_batch_1.json"
