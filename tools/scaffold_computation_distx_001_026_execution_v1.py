#!/usr/bin/env python3
"""Create the twenty-six mechanical DISTX execution entry points."""
import sys
...
def main():
    for claim_id in IDS:
        ...
        if path.exists(): raise SystemExit("DISTX execution entry already exists: " + claim_id)
    ...
    print(f"created {len(IDS)} DISTX execution entry points")
