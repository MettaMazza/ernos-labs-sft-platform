...
from sft.chemistry.inorganic_acid_base_redox_network_batch_v1 import (  # noqa: E402
    INORGANIC_ACID_BASE_REDOX_NETWORK_SPEC,
    PRIMARY_PATH,
)
from sft.chemistry.inorganic_acid_base_redox_network_validation_v1 import (  # noqa: E402
    _source_rows,
    exact_analysis,
)
...
def load_execution():
    path = ROOT / "claims" / INORGANIC_ACID_BASE_REDOX_NETWORK_SPEC.claim_id / "execution.py"
...
def main() -> None:
    spec = INORGANIC_ACID_BASE_REDOX_NETWORK_SPEC
    ...
    certificate = {
        "claim_id": spec.claim_id,
        "chemistry_obligation": "SFT-CHEM-OBL-INORG-017",
        ...
        **analysis,
        ...
        "external_signed_oxidation_number_or_named_criterion_used_to_select_survivor": False,
    ...
    (package / "STATUS.md").write_text(
        ...
        "- Complete Lewis pair/adduct and conserved redox transfer network with ordered paths and exact reverse.\n"
        "- External vector: fifteen rows from five IUPAC records; one absent rendered example preserved.\n"
