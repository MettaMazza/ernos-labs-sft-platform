...
PREVIOUS = ROOT / "census/information_science_discipline_current_reconciliation_v6.json"
OUT = ROOT / "census/information_science_discipline_current_reconciliation_v7.json"
AUDIT = ROOT / "audits/INFORMATION_SCIENCE_COMP_001_014_COMPLETION_2026-07-29.json"

from sft.information_science.comp_001_014_laws_v1 import IDS
...
def main():
    ...
    if canonical(frozen_body) != frozen_identity or canonical(previous_body) != previous_identity or previous["current_closed_count"] != 82:
    ...
    for index, claim_id in enumerate(IDS, 1):
        ...
        obligation = f"SFT-INFO-OBL-COMP-{index:03d}"
    ...
    families["COMP"] = rows
    value = {
        "schema": "sft-v3-information-science-discipline-current-reconciliation/7",
        "date": "2026-07-29",
        ...
        "current_closed_count": 96,
        "current_open_count": 166,
        "current_completion_fraction": "96/262",
        "current_completion_percent": "36.6%",
    ...
    audit = {
        "schema": "sft-v3-information-science-comp-completion/1",
        "date": "2026-07-29",
        "family": "COMP-001--014",
        ...
        "current_information_science_progress": "96/262",
        "current_information_science_percent": "36.6%",
        "reconciliation_identity": value["reconciliation_identity"],
    }
    AUDIT.write_text(json.dumps(audit, indent=2, sort_keys=True) + "\n")
    print(json.dumps({"closed": 96, "open": 166, "percent": "36.6%", "identity": value["reconciliation_identity"]}, indent=2))
