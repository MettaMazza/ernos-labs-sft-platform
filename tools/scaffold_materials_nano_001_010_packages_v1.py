#!/usr/bin/env python3
"""Create all NANO claim and experiment packages from frozen specifications."""
...
from sft.materials.nano_001_010_external_v1 import experiment_registration
...
def main():
    for claim_id in ORDER:
        ...
        write(package / "registration.json", {
            ...
            "branch": "materials",
            "subbranch": "nanomaterials_two_dimensional_quantum_materials",
            "claim_id": claim_id,
            "title": spec.title,
            ...
            "pre_source_target_registry": "census/materials_nano_001_010_target_registry_v1.json",
        ...
        write(experiment / "registration.json", {
            ...
            "schema": "sft-v3-materials-nano-experiment-registration/1",
            **experiment_registration(spec),
            ...
            "target_registry": "census/materials_nano_001_010_target_registry_v1.json",
            "source_custody_manifest": "experiments/external_sources/materials/nano_001_010_v1/source_custody_manifest.json",
            "complete_evidence_vector": "experiments/external_sources/materials/nano_001_010_v1/complete_evidence_vector_v1.json",
    ...
    print("scaffolded", len(ORDER), "NANO packages")
