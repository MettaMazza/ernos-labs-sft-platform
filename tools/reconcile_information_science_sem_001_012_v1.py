...
PREVIOUS = ROOT / "census/information_science_discipline_current_reconciliation_v17.json"
OUT = ROOT / "census/information_science_discipline_current_reconciliation_v18.json"
AUDIT = ROOT / "audits/INFORMATION_SCIENCE_SEM_001_012_COMPLETION_2026-07-29.json"
...
def main():
    ...
    if canonical(frozen_body) != frozen_identity or canonical(previous_body) != previous_identity or previous["current_closed_count"] != 232:
        raise SystemExit("SEM reconciliation predecessor changed")
    ...
    for index, claim_id in enumerate(IDS, 1):
        ...
        obligation = f"SFT-INFO-OBL-SEM-{index:03d}"
        if not row["model_admitted"] or certificate["engine_receipt_hash"] != row["receipt_hash"] or certificate["information_science_obligation"] != obligation:
            raise SystemExit("SEM reconciliation halt: " + claim_id)
        rows.append({
    ...
    families["SEM"] = rows
    value = {
        "schema": "sft-v3-information-science-discipline-current-reconciliation/18",
        "date": "2026-07-29",
        ...
        "current_closed_count": 244,
        "current_open_count": 18,
        "current_completion_fraction": "244/262",
        "current_completion_percent": "93.1%",
    ...
    audit = {
        "schema": "sft-v3-information-science-sem-completion/1",
        "date": "2026-07-29",
        "family": "SEM-001--012",
        ...
        "current_information_science_progress": "244/262",
        "current_information_science_percent": "93.1%",
        "reconciliation_identity": value["reconciliation_identity"],
    }
    AUDIT.write_text(json.dumps(audit, indent=2, sort_keys=True) + "\n")
    print(json.dumps({"closed": 244, "open": 18, "percent": "93.1%", "identity": value["reconciliation_identity"]}, indent=2))
