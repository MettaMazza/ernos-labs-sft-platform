...
PREVIOUS = ROOT / "census/information_science_discipline_current_reconciliation_v18.json"
OUT = ROOT / "census/information_science_discipline_current_reconciliation_v19.json"
AUDIT = ROOT / "audits/INFORMATION_SCIENCE_VALID_001_012_COMPLETION_2026-07-29.json"

from sft.information_science.valid_001_012_laws_v1 import IDS
...
def main():
    ...
    if canonical(frozen_body) != frozen_identity or canonical(previous_body) != previous_identity or previous["current_closed_count"] != 244:
    ...
    for index, claim_id in enumerate(IDS, 1):
        ...
        obligation = f"SFT-INFO-OBL-VALID-{index:03d}"
    ...
    families["VALID"] = rows
    value = {
        "schema": "sft-v3-information-science-discipline-current-reconciliation/19",
        "date": "2026-07-29",
        ...
        "current_closed_count": 256,
        "current_open_count": 6,
        "current_completion_fraction": "256/262",
        "current_completion_percent": "97.7%",
    ...
    audit = {
        "schema": "sft-v3-information-science-valid-completion/1",
        "date": "2026-07-29",
        ...
        "current_information_science_progress": "256/262",
        "current_information_science_percent": "97.7%",
        "reconciliation_identity": value["reconciliation_identity"],
    }
    AUDIT.write_text(json.dumps(audit, indent=2, sort_keys=True) + "\n")
    print(json.dumps({"closed": 256, "open": 6, "percent": "97.7%", "identity": value["reconciliation_identity"]}, indent=2))
