#!/usr/bin/env python3
"""Official one-shot admission for Chemistry ORG-009."""
...
from sft.chemistry.addition_reaction_batch_v3 import ADDITION_REACTION_SPEC  # noqa: E402
from sft.chemistry.addition_reaction_validation_v3 import exact_analysis  # noqa: E402
...
def load_execution():
    path = ROOT / "claims" / ADDITION_REACTION_SPEC.claim_id / "execution.py"
...
def main() -> None:
    ...
    certificate = {
        "claim_id": spec.claim_id,
        "chemistry_obligation": "SFT-CHEM-OBL-ORG-009",
        ...
        **analysis,
        ...
        "conventional_addition_name_product_database_row_atom_map_or_measured_outcome_used_to_generate_or_select_law": False,
    ...
    (package / "STATUS.md").write_text(
        ...
        "- Exact law: all source carriers, atom occurrences and held supports remain in one product; exactly two new cross-carrier adjacencies form while a positive finite multiplicity family relocates with base incidences retained.\n"
        "- Complete site family: same-site, adjacent-site and positive finite non-adjacent attachment classes.\n"
