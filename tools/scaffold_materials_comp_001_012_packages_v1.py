#!/usr/bin/env python3
"""Create all COMP claim and experiment packages from frozen specifications."""
...
from sft.materials.comp_001_012_external_v1 import experiment_registration
from sft.materials.comp_001_012_laws_v1 import ORDER, SPECS
from sft.physics.structural_constants import completeness_record, survivor_id

REGISTRY_ID = "sha256:f2ead1cc8893e0762c706f5353d7edd89cb1eba4241db89cdb8b7ab3b0f4f762"
VECTOR_ID = "sha256:4388b59269538874e5f65ad00fdf02ccb560eb794d67d0309cde1be8e66a21fa"
...
def main():
    for claim_id in ORDER:
        ...
        write(package / "registration.json", {
            ...
            "branch": "materials",
            "subbranch": "computational_materials_structure_property_exact_uncertainty",
            "claim_id": claim_id,
            "title": spec.title,
            ...
            "pre_source_target_registry": "census/materials_comp_001_012_target_registry_v1.json",
        ...
        write(experiment / "registration.json", {
            ...
            "schema": "sft-v3-materials-comp-experiment-registration/1",
            **experiment_registration(spec),
            ...
            "target_registry": "census/materials_comp_001_012_target_registry_v1.json",
            "source_custody_manifest": "experiments/external_sources/materials/comp_001_012_v1/source_custody_manifest.json",
            "complete_evidence_vector": "experiments/external_sources/materials/comp_001_012_v1/complete_evidence_vector_v1.json",
    ...
    print("scaffolded", len(ORDER), "COMP packages")
