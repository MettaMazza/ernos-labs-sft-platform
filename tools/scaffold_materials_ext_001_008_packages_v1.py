#!/usr/bin/env python3
"""Create all EXT claim and experiment packages from frozen specifications."""
...
from sft.materials.ext_001_008_external_v1 import experiment_registration
from sft.materials.ext_001_008_laws_v1 import ORDER, SPECS
from sft.physics.structural_constants import completeness_record, survivor_id

REGISTRY_ID = "sha256:b66b02b91e18ebd9f20a5b03e0500fa44931a76765ae6cb5edecca8ae48ff52f"
VECTOR_ID = "sha256:471dbb411a5fbb6b620661987ce8867bd413bb80b2e58fd7920d68ef36e37388"
...
def main():
    for claim_id in ORDER:
        ...
        write(package / "registration.json", {
            ...
            "branch": "materials",
            "subbranch": "materials_under_extreme_conditions_complete_path_custody",
            "claim_id": claim_id,
            "title": spec.title,
            ...
            "pre_source_target_registry": "census/materials_ext_001_008_target_registry_v1.json",
        ...
        write(experiment / "registration.json", {
            ...
            "schema": "sft-v3-materials-ext-experiment-registration/1",
            **experiment_registration(spec),
            ...
            "target_registry": "census/materials_ext_001_008_target_registry_v1.json",
            "source_custody_manifest": "experiments/external_sources/materials/ext_001_008_v1/source_custody_manifest.json",
            "complete_evidence_vector": "experiments/external_sources/materials/ext_001_008_v1/complete_evidence_vector_v1.json",
    ...
    print("scaffolded", len(ORDER), "EXT packages")
