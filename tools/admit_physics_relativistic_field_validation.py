#!/usr/bin/env python3
"""Admit and materialize post-seal relativistic/field validations."""
...
def load_execution(claim_id: str):
    ...
    definition = importlib.util.spec_from_file_location("sft_field_validation_" + claim_id.replace("-", "_"), path)
