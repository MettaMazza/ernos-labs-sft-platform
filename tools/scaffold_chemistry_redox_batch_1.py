"""Materialize the pre-source-sealed affinity and redox batch."""
...
def build_execution(root: Path) -> ClaimExecution:
    spec = next(item for item in REDOX_BATCH_1_SPECS if item.claim_id == {spec.claim_id!r})
    source_files = (
...
def main() -> None:
    ...
    for spec in REDOX_BATCH_1_SPECS:
        ...
        registration["pre_source_derivation_seal"] = "experiments/sealed_predictions/chemistry_redox_batch_1_pre_source.json"
        ...
        record["pre_source_derivation_seal"] = "experiments/sealed_predictions/chemistry_redox_batch_1_pre_source.json"
        record["authority_support_registry"] = "experiments/external_sources/chemistry/observations_redox_batch_1.json"
