#!/usr/bin/env python3
"""Create registered ELEC claim and experiment packages from frozen specifications."""
import json
...
from sft.materials.elec_001_012_external_v1 import experiment_registration
from sft.materials.elec_001_012_laws_v1 import ORDER, SPECS
from sft.physics.structural_constants import completeness_record, survivor_id

REGISTRY_ID = "sha256:6e93f295af3e3fd65e132e6cc12f3683757bcb4b4a1095c5d3ca980590e71cf5"
VECTOR_ID = "sha256:323bb430589f330fda5ab7ca7d509f8c178440498e9be9c3773a612c7d5bf5dc"
...
def main():
    for claim_id in ORDER:
        ...
        write(package / "registration.json", {
            ...
            "branch": "materials",
            "subbranch": "electronic_dielectric_semiconductor_ionic_transport",
            "claim_id": claim_id,
            "title": spec.title,
            ...
            "pre_source_target_registry": "census/materials_elec_001_012_target_registry_v1.json",
        ...
        write(experiment / "registration.json", {
            ...
            "schema": "sft-v3-materials-elec-experiment-registration/1",
            **experiment_registration(spec),
            ...
            "target_registry": "census/materials_elec_001_012_target_registry_v1.json",
            "source_custody_manifest": "experiments/external_sources/materials/elec_001_012_v1/source_custody_manifest.json",
            "complete_evidence_vector": "experiments/external_sources/materials/elec_001_012_v1/complete_evidence_vector_v1.json",
    ...
    print("scaffolded", len(ORDER), "ELEC packages")
