...
Fold formal-specification law is required to derive exact admissible behavior descriptions without importing its conventional answer-producing model.
...
> The structural One supplies one canonical exact admissible behavior descriptions form with its identity trace and no unrecorded predecessor.

Depth-independent successor:

> Appending one generated exact admissible behavior descriptions form adds its exact carrier row, relations, trace positions and new pair/interface distinctions while preserving every earlier record.
...
- `semantics-witness-1` — semantics exact operational witness 1 for SFT-COMP-SEM-SPECIFICATION-001
- `semantics-witness-2` — semantics exact operational witness 2 for SFT-COMP-SEM-SPECIFICATION-001
- `semantics-witness-3` — semantics exact operational witness 3 for SFT-COMP-SEM-SPECIFICATION-001
...
Conventional terms are downstream correspondence only: formal specification, refinement.
