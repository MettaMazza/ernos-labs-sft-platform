"""Implementation-distinct product validator for SFT-MED-MISSING-REPORTING-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-MISSING-REPORTING-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'registered-and-observed-study-results'), ('relation-imported-fitted-or-erased', 'registration-publication-correspondence'), ('organization-collapsed', 'reported-unreported-support'), ('observation-boundary-unrecorded', 'registry-search-and-cutoff-date'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'registered-and-observed-study-results__registration-publication-correspondence__reported-unreported-support__registry-search-and-cutoff-date__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
