"""Implementation-distinct product validator for SFT-EARTH-CLIMATE-FEEDBACK-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-CLIMATE-FEEDBACK-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'state-response-return-path-carrier'), ('boundary-or-interface-erased', 'process-timescale-bounded'), ('imported-fitted-or-missing-relation', 'response-modifies-driver-or-budget-relation'), ('favourable-output-with-incomplete-record', 'sign-as-orientation-gain-path-delay-and-boundaries-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'state-response-return-path-carrier__process-timescale-bounded__response-modifies-driver-or-budget-relation__sign-as-orientation-gain-path-delay-and-boundaries-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
