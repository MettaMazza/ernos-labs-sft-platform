"""Implementation-distinct product validator for SFT-CONSC-OBSERVATION-ACT-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-CONSC-OBSERVATION-ACT-001'
DOMAINS = (('carrier-absent-or-description-only', 'state-and-fold-image'), ('distinction-collapsed-or-conflated', 'source/image'), ('operation-imported-fitted-or-missing', 'exact-fold-transition'), ('favourable-output-without-complete-trace', 'source-image-trace'), ('report-behaviour-correlation-or-confidence-substituted', 'formal-operation'), ('prior-consensus-target-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-instance-with-erased-alternatives', 'positive-finite-successor-with-all-alternatives'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'state-and-fold-image__source/image__exact-fold-transition__source-image-trace__formal-operation__root-bound-forward-forcing__positive-finite-successor-with-all-alternatives__no-extra-rule'
def main():
