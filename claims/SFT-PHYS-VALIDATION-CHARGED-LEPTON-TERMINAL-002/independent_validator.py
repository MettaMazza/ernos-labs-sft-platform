"""Implementation-distinct product validator for the terminal lepton test."""
...
CLAIM_ID = "SFT-PHYS-VALIDATION-CHARGED-LEPTON-TERMINAL-002"
DOMAINS = (
    ("answer-only-scalar", "complete-fold-carrier"),
    ("imported-or-fitted-relation", "sealed-terminal-cubic-ratios-versus-complete-codata-intervals"),
