"""Implementation-distinct product validator for exact Koide validation."""
...
CLAIM_ID = "SFT-PHYS-VALIDATION-CHARGED-LEPTON-KOIDE-001"
DOMAINS = (
    ("answer-only-scalar", "complete-fold-carrier"),
    ("imported-or-fitted-relation", "sealed-two-thirds-versus-complete-rational-koide-enclosure"),
