"""Implementation-distinct product validator for SFT-CONSC-SUBJECT-CARRIER-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-CONSC-SUBJECT-CARRIER-001'
DOMAINS = (('carrier-absent-or-description-only', 'continuing-integrated-loop'), ('distinction-collapsed-or-conflated', 'subject/content'), ('operation-imported-fitted-or-missing', 'holds-perspective-across-content'), ('favourable-output-without-complete-trace', 'identity-and-content-traces'), ('report-behaviour-correlation-or-confidence-substituted', 'phenomenal-identity'), ('prior-consensus-target-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-instance-with-erased-alternatives', 'positive-finite-successor-with-all-alternatives'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'continuing-integrated-loop__subject/content__holds-perspective-across-content__identity-and-content-traces__phenomenal-identity__root-bound-forward-forcing__positive-finite-successor-with-all-alternatives__no-extra-rule'
def main():
