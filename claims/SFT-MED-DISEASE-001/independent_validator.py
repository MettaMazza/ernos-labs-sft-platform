"""Implementation-distinct product validator for SFT-MED-DISEASE-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-DISEASE-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'patient-process-state'), ('relation-imported-fitted-or-erased', 'persistent-or-recurrent-harmful-process'), ('organization-collapsed', 'mechanism-manifestation-course'), ('observation-boundary-unrecorded', 'diagnostic-criteria-and-time'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'patient-process-state__persistent-or-recurrent-harmful-process__mechanism-manifestation-course__diagnostic-criteria-and-time__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
