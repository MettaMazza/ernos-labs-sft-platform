"""Implementation-distinct product validator for SFT-EARTH-WATER-RESERVOIR-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-WATER-RESERVOIR-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'phase-location-bounded-water-carrier'), ('boundary-or-interface-erased', 'hydrological-domain-bounded'), ('imported-fitted-or-missing-relation', 'storage-membership-and-exchange-relation'), ('favourable-output-with-incomplete-record', 'amount-phase-composition-boundary-and-time-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'phase-location-bounded-water-carrier__hydrological-domain-bounded__storage-membership-and-exchange-relation__amount-phase-composition-boundary-and-time-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
