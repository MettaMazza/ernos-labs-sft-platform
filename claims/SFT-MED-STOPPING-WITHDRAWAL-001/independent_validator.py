"""Implementation-distinct product validator for SFT-MED-STOPPING-WITHDRAWAL-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-STOPPING-WITHDRAWAL-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'ongoing-care-and-patient-state'), ('relation-imported-fitted-or-erased', 'stop-continue-change-decision'), ('organization-collapsed', 'reason-transition-and-aftercare'), ('observation-boundary-unrecorded', 'decision-time-and-follow-up'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'ongoing-care-and-patient-state__stop-continue-change-decision__reason-transition-and-aftercare__decision-time-and-follow-up__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
