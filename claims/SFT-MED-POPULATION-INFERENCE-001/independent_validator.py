"""Implementation-distinct product validator for SFT-MED-POPULATION-INFERENCE-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-POPULATION-INFERENCE-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'sample-and-source-population'), ('relation-imported-fitted-or-erased', 'sample-to-population-relation'), ('organization-collapsed', 'selection-weights-and-missingness'), ('observation-boundary-unrecorded', 'eligibility-place-time-and-method'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'sample-and-source-population__sample-to-population-relation__selection-weights-and-missingness__eligibility-place-time-and-method__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
