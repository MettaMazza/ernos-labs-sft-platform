"""Implementation-distinct product validator for SFT-MED-COUNTERFACTUAL-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-COUNTERFACTUAL-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'same-eligibility-patient-state'), ('relation-imported-fitted-or-erased', 'alternative-action-outcome-relation'), ('organization-collapsed', 'mutually-exclusive-potential-courses'), ('observation-boundary-unrecorded', 'identification-assumption-boundary'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'same-eligibility-patient-state__alternative-action-outcome-relation__mutually-exclusive-potential-courses__identification-assumption-boundary__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
