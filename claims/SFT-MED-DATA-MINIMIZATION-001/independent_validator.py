"""Implementation-distinct product validator for SFT-MED-DATA-MINIMIZATION-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-DATA-MINIMIZATION-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'purpose-declared-data-fields'), ('relation-imported-fitted-or-erased', 'field-necessity-to-purpose'), ('organization-collapsed', 'included-excluded-and-derived-fields'), ('observation-boundary-unrecorded', 'protocol-access-and-retention-period'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'purpose-declared-data-fields__field-necessity-to-purpose__included-excluded-and-derived-fields__protocol-access-and-retention-period__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
