"""Implementation-distinct product validator for SFT-CONSC-RED-QUALITATIVE-IDENTITY-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-CONSC-RED-QUALITATIVE-IDENTITY-001'
DOMAINS = (('carrier-absent-or-description-only', 'within-subject-red-instances'), ('distinction-collapsed-or-conflated', 'red-label/red-quality'), ('operation-imported-fitted-or-missing', 'identity-discrimination'), ('favourable-output-without-complete-trace', 'instance-context-and-alternatives'), ('report-behaviour-correlation-or-confidence-substituted', 'first-person-psychophysical'), ('prior-consensus-target-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-instance-with-erased-alternatives', 'positive-finite-successor-with-all-alternatives'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'within-subject-red-instances__red-label/red-quality__identity-discrimination__instance-context-and-alternatives__first-person-psychophysical__root-bound-forward-forcing__positive-finite-successor-with-all-alternatives__no-extra-rule'
def main():
