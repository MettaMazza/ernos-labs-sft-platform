"""Implementation-distinct product validator for SFT-EARTH-GEOLOGICAL-MATERIAL-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-GEOLOGICAL-MATERIAL-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'specimen-composition-phase-texture-carrier'), ('boundary-or-interface-erased', 'specimen-method-bounded'), ('imported-fitted-or-missing-relation', 'material-class-equivalence'), ('favourable-output-with-incomplete-record', 'provenance-mineralogy-chemistry-structure-and-scale-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'specimen-composition-phase-texture-carrier__specimen-method-bounded__material-class-equivalence__provenance-mineralogy-chemistry-structure-and-scale-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
