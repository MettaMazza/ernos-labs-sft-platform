"""Implementation-distinct product validator for SFT-EARTH-OCEAN-COMPOSITION-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-OCEAN-COMPOSITION-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'water-dissolved-particulate-gas-carrier'), ('boundary-or-interface-erased', 'sample-program-bounded'), ('imported-fitted-or-missing-relation', 'composition-fraction-and-transformation-relation'), ('favourable-output-with-incomplete-record', 'species-basis-depth-location-time-and-method-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'water-dissolved-particulate-gas-carrier__sample-program-bounded__composition-fraction-and-transformation-relation__species-basis-depth-location-time-and-method-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
