"""Implementation-distinct product validator for SFT-MED-COMPARATOR-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-COMPARATOR-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'alternative-care-action'), ('relation-imported-fitted-or-erased', 'contrast-with-intervention'), ('organization-collapsed', 'concurrent-or-declared-reference'), ('observation-boundary-unrecorded', 'same-eligibility-outcome-and-time'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'alternative-care-action__contrast-with-intervention__concurrent-or-declared-reference__same-eligibility-outcome-and-time__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
