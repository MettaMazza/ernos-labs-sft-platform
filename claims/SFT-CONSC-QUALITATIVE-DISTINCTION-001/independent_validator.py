"""Implementation-distinct product validator for SFT-CONSC-QUALITATIVE-DISTINCTION-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-CONSC-QUALITATIVE-DISTINCTION-001'
DOMAINS = (('carrier-absent-or-description-only', 'paired-interior-content-labels'), ('distinction-collapsed-or-conflated', 'same/different-quality'), ('operation-imported-fitted-or-missing', 'within-subject-discrimination'), ('favourable-output-without-complete-trace', 'stimulus-report-context'), ('report-behaviour-correlation-or-confidence-substituted', 'first-person-psychophysical'), ('prior-consensus-target-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-instance-with-erased-alternatives', 'positive-finite-successor-with-all-alternatives'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'paired-interior-content-labels__same/different-quality__within-subject-discrimination__stimulus-report-context__first-person-psychophysical__root-bound-forward-forcing__positive-finite-successor-with-all-alternatives__no-extra-rule'
def main():
