"""Implementation-distinct product validator for SFT-MED-REHABILITATION-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-REHABILITATION-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'person-function-and-participation-state'), ('relation-imported-fitted-or-erased', 'iterated-action-to-capacity-change'), ('organization-collapsed', 'goals-interventions-context-and-course'), ('observation-boundary-unrecorded', 'baseline-follow-up-and-lived-setting'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'person-function-and-participation-state__iterated-action-to-capacity-change__goals-interventions-context-and-course__baseline-follow-up-and-lived-setting__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
