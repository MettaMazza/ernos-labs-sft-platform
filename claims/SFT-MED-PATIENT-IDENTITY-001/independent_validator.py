"""Implementation-distinct product validator for SFT-MED-PATIENT-IDENTITY-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-PATIENT-IDENTITY-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'consented-person-record'), ('relation-imported-fitted-or-erased', 'same-person-across-episodes'), ('organization-collapsed', 'identity-with-held-linkage'), ('observation-boundary-unrecorded', 'declared-care-context-and-interval'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'consented-person-record__same-person-across-episodes__identity-with-held-linkage__declared-care-context-and-interval__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
