"""Implementation-distinct product validator for SFT-MED-INCIDENCE-PREVALENCE-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-INCIDENCE-PREVALENCE-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'population-condition-records'), ('relation-imported-fitted-or-erased', 'new-event-versus-state-support'), ('organization-collapsed', 'flow-and-stock-kept-distinct'), ('observation-boundary-unrecorded', 'population-and-time-boundary'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'population-condition-records__new-event-versus-state-support__flow-and-stock-kept-distinct__population-and-time-boundary__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
