"""Implementation-distinct product validator for SFT-MED-ADVERSE-EVENT-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-ADVERSE-EVENT-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'participant-unfavorable-event'), ('relation-imported-fitted-or-erased', 'event-after-exposure-or-care'), ('organization-collapsed', 'seriousness-severity-relatedness-outcome'), ('observation-boundary-unrecorded', 'solicitation-time-and-follow-up'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'participant-unfavorable-event__event-after-exposure-or-care__seriousness-severity-relatedness-outcome__solicitation-time-and-follow-up__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
