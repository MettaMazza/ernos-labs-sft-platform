"""Implementation-distinct product validator for SFT-EARTH-SOURCE-SINK-STORAGE-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-SOURCE-SINK-STORAGE-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'process-reservoir-role-carrier'), ('boundary-or-interface-erased', 'system-boundary-bounded'), ('imported-fitted-or-missing-relation', 'boundary-relative-role-assignment'), ('favourable-output-with-incomplete-record', 'direction-duration-capacity-and-reversal-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'process-reservoir-role-carrier__system-boundary-bounded__boundary-relative-role-assignment__direction-duration-capacity-and-reversal-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
