"""Implementation-distinct product validator for SFT-MED-TREATMENT-HETEROGENEITY-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-TREATMENT-HETEROGENEITY-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'predeclared-patient-strata'), ('relation-imported-fitted-or-erased', 'arm-contrast-by-stratum'), ('organization-collapsed', 'joint-stratum-arm-outcome'), ('observation-boundary-unrecorded', 'multiplicity-and-scale-boundary'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'predeclared-patient-strata__arm-contrast-by-stratum__joint-stratum-arm-outcome__multiplicity-and-scale-boundary__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
