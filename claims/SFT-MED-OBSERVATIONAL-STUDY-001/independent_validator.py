"""Implementation-distinct product validator for SFT-MED-OBSERVATIONAL-STUDY-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-OBSERVATIONAL-STUDY-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'sampled-person-records'), ('relation-imported-fitted-or-erased', 'observed-exposure-outcome-relation'), ('organization-collapsed', 'sampling-selection-and-confounders'), ('observation-boundary-unrecorded', 'source-population-time-and-follow-up'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'sampled-person-records__observed-exposure-outcome-relation__sampling-selection-and-confounders__source-population-time-and-follow-up__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
