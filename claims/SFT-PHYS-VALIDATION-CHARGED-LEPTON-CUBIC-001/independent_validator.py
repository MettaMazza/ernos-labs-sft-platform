"""Implementation-distinct product validator for the lepton empirical test."""
...
DOMAINS = (
    ...
    ("imported-or-fitted-relation", "sealed-cubic-ratios-versus-complete-codata-intervals"),
