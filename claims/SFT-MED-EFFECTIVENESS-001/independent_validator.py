"""Implementation-distinct product validator for SFT-MED-EFFECTIVENESS-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-EFFECTIVENESS-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'practice-intervention-comparison'), ('relation-imported-fitted-or-erased', 'outcome-contrast-under-usual-care'), ('organization-collapsed', 'delivery-adherence-context-variation'), ('observation-boundary-unrecorded', 'practice-population-and-horizon'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'practice-intervention-comparison__outcome-contrast-under-usual-care__delivery-adherence-context-variation__practice-population-and-horizon__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
