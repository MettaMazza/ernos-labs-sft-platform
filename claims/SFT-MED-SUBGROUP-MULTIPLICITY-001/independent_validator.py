"""Implementation-distinct product validator for SFT-MED-SUBGROUP-MULTIPLICITY-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-SUBGROUP-MULTIPLICITY-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'generated-subgroup-comparisons'), ('relation-imported-fitted-or-erased', 'comparison-count-and-result-incidence'), ('organization-collapsed', 'complete-tested-family'), ('observation-boundary-unrecorded', 'predeclaration-and-selection-boundary'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'generated-subgroup-comparisons__comparison-count-and-result-incidence__complete-tested-family__predeclaration-and-selection-boundary__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
