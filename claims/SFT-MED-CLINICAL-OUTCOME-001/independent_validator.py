"""Implementation-distinct product validator for SFT-MED-CLINICAL-OUTCOME-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-CLINICAL-OUTCOME-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'patient-endpoint-state'), ('relation-imported-fitted-or-erased', 'change-or-event-from-baseline'), ('organization-collapsed', 'endpoint-definition-and-components'), ('observation-boundary-unrecorded', 'assessment-time-method-and-blinding'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'patient-endpoint-state__change-or-event-from-baseline__endpoint-definition-and-components__assessment-time-method-and-blinding__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
