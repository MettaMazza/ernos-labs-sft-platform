"""Implementation-distinct product validator for SFT-CONSC-RED-CONTROLS-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-CONSC-RED-CONTROLS-001'
DOMAINS = (('carrier-absent-or-description-only', 'red-and-nonred-comparison-set'), ('distinction-collapsed-or-conflated', 'identity/mismatch'), ('operation-imported-fitted-or-missing', 'changed-label-and-changed-stimulus-tests'), ('favourable-output-without-complete-trace', 'all-match-mismatch-absence-uncertain-rows'), ('report-behaviour-correlation-or-confidence-substituted', 'first-person-psychophysical'), ('prior-consensus-target-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-instance-with-erased-alternatives', 'positive-finite-successor-with-all-alternatives'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'red-and-nonred-comparison-set__identity/mismatch__changed-label-and-changed-stimulus-tests__all-match-mismatch-absence-uncertain-rows__first-person-psychophysical__root-bound-forward-forcing__positive-finite-successor-with-all-alternatives__no-extra-rule'
def main():
