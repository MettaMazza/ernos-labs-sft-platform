"""Implementation-distinct product validator for SFT-MED-ABSOLUTE-RELATIVE-EFFECT-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-ABSOLUTE-RELATIVE-EFFECT-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'arm-specific-outcome-counts'), ('relation-imported-fitted-or-erased', 'absolute-and-relative-comparison'), ('organization-collapsed', 'complete-two-arm-event-table'), ('observation-boundary-unrecorded', 'population-and-horizon'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'arm-specific-outcome-counts__absolute-and-relative-comparison__complete-two-arm-event-table__population-and-horizon__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
