"""Implementation-distinct product validator for SFT-CONSC-PHENOMENAL-PRESENCE-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-CONSC-PHENOMENAL-PRESENCE-001'
DOMAINS = (('carrier-absent-or-description-only', 'interiorly-realized-content'), ('distinction-collapsed-or-conflated', 'present/merely-processed'), ('operation-imported-fitted-or-missing', 'closed-interior-observation'), ('favourable-output-without-complete-trace', 'first-person-discrimination'), ('report-behaviour-correlation-or-confidence-substituted', 'phenomenal'), ('prior-consensus-target-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-instance-with-erased-alternatives', 'positive-finite-successor-with-all-alternatives'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'interiorly-realized-content__present/merely-processed__closed-interior-observation__first-person-discrimination__phenomenal__root-bound-forward-forcing__positive-finite-successor-with-all-alternatives__no-extra-rule'
def main():
