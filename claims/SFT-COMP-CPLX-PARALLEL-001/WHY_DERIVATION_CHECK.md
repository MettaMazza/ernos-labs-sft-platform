...
> The structural One supplies one canonical independent and causally layered work form with its identity trace and no unrecorded predecessor.

Depth-independent successor:

> Appending one generated independent and causally layered work form adds its exact carrier row, relations, trace positions and new pair/interface distinctions while preserving every earlier record.
...
- `complexity-witness-1` — complexity exact operational witness 1 for SFT-COMP-CPLX-PARALLEL-001
- `complexity-witness-2` — complexity exact operational witness 2 for SFT-COMP-CPLX-PARALLEL-001
- `complexity-witness-3` — complexity exact operational witness 3 for SFT-COMP-CPLX-PARALLEL-001
...
Conventional terms are downstream correspondence only: parallel complexity, work and span.
