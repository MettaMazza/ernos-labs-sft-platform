"""Implementation-distinct product validator for SFT-EARTH-ABSENCE-MISSINGNESS-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-ABSENCE-MISSINGNESS-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'complete-observation-status-carrier'), ('boundary-or-interface-erased', 'detection-boundary-declared'), ('imported-fitted-or-missing-relation', 'status-class-distinction'), ('favourable-output-with-incomplete-record', 'detected-absent-censored-missing-outside-scope-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'complete-observation-status-carrier__detection-boundary-declared__status-class-distinction__detected-absent-censored-missing-outside-scope-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
