# Fold computability-reduction law
...
> The structural One supplies one canonical problem translation preserving answers form with its identity trace and no unrecorded predecessor.

Depth-independent successor:

> Appending one generated problem translation preserving answers form adds its exact carrier row, relations, trace positions and new pair/interface distinctions while preserving every earlier record.
...
- `computability-witness-1` — computability exact operational witness 1 for SFT-COMP-CBL-REDUCTION-001
- `computability-witness-2` — computability exact operational witness 2 for SFT-COMP-CBL-REDUCTION-001
- `computability-witness-3` — computability exact operational witness 3 for SFT-COMP-CBL-REDUCTION-001
...
Conventional terms are downstream correspondence only: many-one reduction, computability reduction.
