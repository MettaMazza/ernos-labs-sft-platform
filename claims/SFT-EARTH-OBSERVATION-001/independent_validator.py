"""Implementation-distinct product validator for SFT-EARTH-OBSERVATION-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-OBSERVATION-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'source-instrument-processing-result-carrier'), ('boundary-or-interface-erased', 'method-validity-bounded'), ('imported-fitted-or-missing-relation', 'source-to-record-trace'), ('favourable-output-with-incomplete-record', 'location-time-calibration-processing-and-quality-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'source-instrument-processing-result-carrier__method-validity-bounded__source-to-record-trace__location-time-calibration-processing-and-quality-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
