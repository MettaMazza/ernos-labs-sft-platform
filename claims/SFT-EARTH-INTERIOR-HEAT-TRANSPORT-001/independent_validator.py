"""Implementation-distinct product validator for SFT-EARTH-INTERIOR-HEAT-TRANSPORT-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-INTERIOR-HEAT-TRANSPORT-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'temperature-material-motion-carrier'), ('boundary-or-interface-erased', 'interior-scale-bounded'), ('imported-fitted-or-missing-relation', 'conduction-advection-and-transition-relation'), ('favourable-output-with-incomplete-record', 'geometry-properties-boundaries-time-and-flux-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'temperature-material-motion-carrier__interior-scale-bounded__conduction-advection-and-transition-relation__geometry-properties-boundaries-time-and-flux-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
