"""Implementation-distinct product validator for SFT-EARTH-CRUST-MANTLE-BOUNDARY-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-CRUST-MANTLE-BOUNDARY-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'solid-earth-interface-carrier'), ('boundary-or-interface-erased', 'regional-observation-bounded'), ('imported-fitted-or-missing-relation', 'composition-structure-and-wave-contrast'), ('favourable-output-with-incomplete-record', 'depth-lateral-variation-method-and-uncertainty-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'solid-earth-interface-carrier__regional-observation-bounded__composition-structure-and-wave-contrast__depth-lateral-variation-method-and-uncertainty-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
