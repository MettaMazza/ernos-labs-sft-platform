...
> The structural One supplies one canonical prefix-bounded processing form with its identity trace and no unrecorded predecessor.

Depth-independent successor:

> Appending one generated prefix-bounded processing form adds its exact carrier row, relations, trace positions and new pair/interface distinctions while preserving every earlier record.
...
- `algorithms-witness-1` — algorithms exact operational witness 1 for SFT-COMP-ALG-ONLINE-STREAMING-001
...
Conventional terms are downstream correspondence only: online algorithm, streaming algorithm.
