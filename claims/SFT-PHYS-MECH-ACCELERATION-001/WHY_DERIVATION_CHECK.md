...
Claim: `SFT-PHYS-MECH-ACCELERATION-001`
...
`complete-fold-carrier__velocity-change-per-recurrence__source-bound-proof-trace__capability-closed-prediction__separate-measurement-record__complete-registered-rows__one-successor-closure__no-extra-rule`
