"""Implementation-distinct product validator for SFT-CONSC-RED-OF-RED-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-CONSC-RED-OF-RED-001'
DOMAINS = (('carrier-absent-or-description-only', 'red-quality-and-self-observation'), ('distinction-collapsed-or-conflated', 'quality/report-about-quality'), ('operation-imported-fitted-or-missing', 'label-bearing-recurrent-self-observation'), ('favourable-output-without-complete-trace', 'source-instance-recurrence-self-report'), ('report-behaviour-correlation-or-confidence-substituted', 'first-person-specific-qualia'), ('prior-consensus-target-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-instance-with-erased-alternatives', 'positive-finite-successor-with-all-alternatives'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'red-quality-and-self-observation__quality/report-about-quality__label-bearing-recurrent-self-observation__source-instance-recurrence-self-report__first-person-specific-qualia__root-bound-forward-forcing__positive-finite-successor-with-all-alternatives__no-extra-rule'
def main():
