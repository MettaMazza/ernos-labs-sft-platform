"""Implementation-distinct product validator for SFT-MED-EXPOSURE-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-EXPOSURE-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'person-agent-contact-word'), ('relation-imported-fitted-or-erased', 'contact-intensity-duration-route'), ('organization-collapsed', 'source-path-person-time'), ('observation-boundary-unrecorded', 'measurement-and-reconstruction-method'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'person-agent-contact-word__contact-intensity-duration-route__source-path-person-time__measurement-and-reconstruction-method__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
