"""Implementation-distinct product validator for SFT-EARTH-CRYOSPHERE-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-CRYOSPHERE-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'snow-ice-frozen-ground-carrier'), ('boundary-or-interface-erased', 'method-region-time-bounded'), ('imported-fitted-or-missing-relation', 'accumulation-transport-phase-and-loss-relation'), ('favourable-output-with-incomplete-record', 'extent-thickness-mass-motion-age-and-uncertainty-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'snow-ice-frozen-ground-carrier__method-region-time-bounded__accumulation-transport-phase-and-loss-relation__extent-thickness-mass-motion-age-and-uncertainty-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
