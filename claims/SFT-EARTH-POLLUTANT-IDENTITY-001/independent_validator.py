"""Implementation-distinct product validator for SFT-EARTH-POLLUTANT-IDENTITY-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-POLLUTANT-IDENTITY-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'substance-form-source-context-carrier'), ('boundary-or-interface-erased', 'environment-health-handoff-bounded'), ('imported-fitted-or-missing-relation', 'harm-relevant-exposure-classification'), ('favourable-output-with-incomplete-record', 'chemical-form-source-medium-dose-time-and-endpoint-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'substance-form-source-context-carrier__environment-health-handoff-bounded__harm-relevant-exposure-classification__chemical-form-source-medium-dose-time-and-endpoint-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
