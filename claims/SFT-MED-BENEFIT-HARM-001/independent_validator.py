"""Implementation-distinct product validator for SFT-MED-BENEFIT-HARM-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-BENEFIT-HARM-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'joint-benefit-and-harm-outcomes'), ('relation-imported-fitted-or-erased', 'noncollapsed-outcome-comparison'), ('organization-collapsed', 'patient-valued-components-held'), ('observation-boundary-unrecorded', 'population-horizon-and-preference-boundary'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'joint-benefit-and-harm-outcomes__noncollapsed-outcome-comparison__patient-valued-components-held__population-horizon-and-preference-boundary__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
