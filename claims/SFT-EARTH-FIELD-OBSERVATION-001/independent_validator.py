"""Implementation-distinct product validator for SFT-EARTH-FIELD-OBSERVATION-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-FIELD-OBSERVATION-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'site-specimen-instrument-result-carrier'), ('boundary-or-interface-erased', 'representativeness-declared'), ('imported-fitted-or-missing-relation', 'sampling-to-population-relation'), ('favourable-output-with-incomplete-record', 'design-location-time-effort-calibration-and-exclusions-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'site-specimen-instrument-result-carrier__representativeness-declared__sampling-to-population-relation__design-location-time-effort-calibration-and-exclusions-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
