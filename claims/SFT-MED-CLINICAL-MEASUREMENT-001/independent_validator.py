"""Implementation-distinct product validator for SFT-MED-CLINICAL-MEASUREMENT-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-CLINICAL-MEASUREMENT-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'patient-specimen-or-signal'), ('relation-imported-fitted-or-erased', 'traceable-measurement-relation'), ('organization-collapsed', 'method-unit-calibration-result'), ('observation-boundary-unrecorded', 'preanalytic-analytic-postanalytic-boundary'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'patient-specimen-or-signal__traceable-measurement-relation__method-unit-calibration-result__preanalytic-analytic-postanalytic-boundary__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
