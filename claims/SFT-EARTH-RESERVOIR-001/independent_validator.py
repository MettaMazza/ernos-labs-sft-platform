"""Implementation-distinct product validator for SFT-EARTH-RESERVOIR-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-RESERVOIR-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'bounded-stock-membership-carrier'), ('boundary-or-interface-erased', 'reservoir-definition-bounded'), ('imported-fitted-or-missing-relation', 'membership-storage-and-transfer-relation'), ('favourable-output-with-incomplete-record', 'members-stock-units-boundary-and-time-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'bounded-stock-membership-carrier__reservoir-definition-bounded__membership-storage-and-transfer-relation__members-stock-units-boundary-and-time-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
