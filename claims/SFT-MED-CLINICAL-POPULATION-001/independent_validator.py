"""Implementation-distinct product validator for SFT-MED-CLINICAL-POPULATION-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-CLINICAL-POPULATION-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'finite-person-carriers'), ('relation-imported-fitted-or-erased', 'membership-under-declared-criteria'), ('organization-collapsed', 'population-with-each-person-held'), ('observation-boundary-unrecorded', 'place-time-source-frame'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'finite-person-carriers__membership-under-declared-criteria__population-with-each-person-held__place-time-source-frame__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
