"""Implementation-distinct product validator for SFT-MED-SAFETY-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-SAFETY-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'all-exposed-and-comparator-participants'), ('relation-imported-fitted-or-erased', 'favorable-and-unfavorable-event-incidence'), ('organization-collapsed', 'complete-event-severity-time-support'), ('observation-boundary-unrecorded', 'exposure-duration-and-follow-up'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
