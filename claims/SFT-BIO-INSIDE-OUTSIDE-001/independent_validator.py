"""Implementation-distinct product validator for SFT-BIO-INSIDE-OUTSIDE-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-BIO-INSIDE-OUTSIDE-001'
DOMAINS = (('carrier-erased-or-answer-only', 'oriented-boundary-carrier'), ('relation-imported-fitted-or-erased', 'opposed-side-label-relation'), ('organization-collapsed', 'two-sides-never-merged'), ('observation-boundary-unrecorded', 'observer-orientation-declared'), ('result-without-transition-record', 'complete-state-transition-control-record'), ('authority-target-or-prior-selected-law', 'root-bound-forward-forcing'), ('single-specimen-favorable-instance', 'positive-finite-successor-and-adverse-closure'), ('free-fit-exception-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'oriented-boundary-carrier__opposed-side-label-relation__two-sides-never-merged__observer-orientation-declared__complete-state-transition-control-record__root-bound-forward-forcing__positive-finite-successor-and-adverse-closure__no-extra-rule'
def main():
