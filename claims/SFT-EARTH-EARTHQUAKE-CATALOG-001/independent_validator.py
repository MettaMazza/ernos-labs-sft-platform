"""Implementation-distinct product validator for SFT-EARTH-EARTHQUAKE-CATALOG-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-EARTHQUAKE-CATALOG-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'event-detection-location-magnitude-carrier'), ('boundary-or-interface-erased', 'catalog-completeness-bounded'), ('imported-fitted-or-missing-relation', 'catalog-membership-and-equivalence-relation'), ('favourable-output-with-incomplete-record', 'network-threshold-method-duplicates-errors-and-time-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'event-detection-location-magnitude-carrier__catalog-completeness-bounded__catalog-membership-and-equivalence-relation__network-threshold-method-duplicates-errors-and-time-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
