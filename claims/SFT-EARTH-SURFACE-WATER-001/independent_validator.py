"""Implementation-distinct product validator for SFT-EARTH-SURFACE-WATER-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-SURFACE-WATER-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'surface-water-node-edge-carrier'), ('boundary-or-interface-erased', 'catchment-window-bounded'), ('imported-fitted-or-missing-relation', 'storage-routing-and-exchange-relation'), ('favourable-output-with-incomplete-record', 'network-geometry-flow-quality-boundaries-and-time-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'surface-water-node-edge-carrier__catchment-window-bounded__storage-routing-and-exchange-relation__network-geometry-flow-quality-boundaries-and-time-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
