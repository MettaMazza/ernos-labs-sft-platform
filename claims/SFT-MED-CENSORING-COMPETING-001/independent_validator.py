"""Implementation-distinct product validator for SFT-MED-CENSORING-COMPETING-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-CENSORING-COMPETING-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'incomplete-patient-course'), ('relation-imported-fitted-or-erased', 'observability-and-competing-transition'), ('organization-collapsed', 'retained-unobserved-support'), ('observation-boundary-unrecorded', 'reason-time-and-follow-up'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'incomplete-patient-course__observability-and-competing-transition__retained-unobserved-support__reason-time-and-follow-up__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
