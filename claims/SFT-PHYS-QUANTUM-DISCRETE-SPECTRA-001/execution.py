"""Official execution binding for SFT-PHYS-QUANTUM-DISCRETE-SPECTRA-001."""
...
def build_execution(root: Path) -> ClaimExecution:
    spec = next(item for item in QUANTUM_PHYSICS_SPECS if item.claim_id == 'SFT-PHYS-QUANTUM-DISCRETE-SPECTRA-001')
    source_files = (
    ...
    return ClaimExecution(
        ...
        independent_validator=ExternalCommandValidator('sft-phys-quantum-discrete-spectra-001' + "-independent-python/1", (sys.executable, str(validator)), validator.parent, (validator,)),
