"""Implementation-distinct product validator for SFT-EARTH-OCEAN-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-OCEAN-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'bounded-seawater-basin-interface-carrier'), ('boundary-or-interface-erased', 'ocean-observation-bounded'), ('imported-fitted-or-missing-relation', 'storage-motion-composition-and-exchange-relation'), ('favourable-output-with-incomplete-record', 'basin-depth-composition-state-boundaries-and-time-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'bounded-seawater-basin-interface-carrier__ocean-observation-bounded__storage-motion-composition-and-exchange-relation__basin-depth-composition-state-boundaries-and-time-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
