"""Implementation-distinct product validator for SFT-EARTH-GEOLOGICAL-PROVENANCE-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-GEOLOGICAL-PROVENANCE-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'source-path-deposit-carrier'), ('boundary-or-interface-erased', 'method-and-basin-bounded'), ('imported-fitted-or-missing-relation', 'source-to-observed-material-reconstruction'), ('favourable-output-with-incomplete-record', 'composition-age-route-alteration-and-alternatives-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'source-path-deposit-carrier__method-and-basin-bounded__source-to-observed-material-reconstruction__composition-age-route-alteration-and-alternatives-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
