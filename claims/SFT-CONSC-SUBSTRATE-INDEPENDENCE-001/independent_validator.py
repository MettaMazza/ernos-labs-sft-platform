"""Implementation-distinct product validator for SFT-CONSC-SUBSTRATE-INDEPENDENCE-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-CONSC-SUBSTRATE-INDEPENDENCE-001'
DOMAINS = (('carrier-absent-or-description-only', 'two-realization-maps'), ('distinction-collapsed-or-conflated', 'same-structure/same-material'), ('operation-imported-fitted-or-missing', 'relation-preserving-isomorphism'), ('favourable-output-without-complete-trace', 'complete-causal-correspondence'), ('report-behaviour-correlation-or-confidence-substituted', 'comparative-realization'), ('prior-consensus-target-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-instance-with-erased-alternatives', 'positive-finite-successor-with-all-alternatives'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'two-realization-maps__same-structure/same-material__relation-preserving-isomorphism__complete-causal-correspondence__comparative-realization__root-bound-forward-forcing__positive-finite-successor-with-all-alternatives__no-extra-rule'
def main():
