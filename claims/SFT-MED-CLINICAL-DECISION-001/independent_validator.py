"""Implementation-distinct product validator for SFT-MED-CLINICAL-DECISION-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-CLINICAL-DECISION-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'patient-action-alternatives'), ('relation-imported-fitted-or-erased', 'evidence-consequence-preference-relation'), ('organization-collapsed', 'all-actions-outcomes-and-values'), ('observation-boundary-unrecorded', 'decision-maker-time-and-resource-boundary'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
