"""Implementation-distinct product validator for SFT-MED-LONGITUDINAL-COURSE-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-LONGITUDINAL-COURSE-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'ordered-patient-states'), ('relation-imported-fitted-or-erased', 'within-person-transition-relation'), ('organization-collapsed', 'course-with-missing-visits-held'), ('observation-boundary-unrecorded', 'declared-follow-up-and-censoring'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'ordered-patient-states__within-person-transition-relation__course-with-missing-visits-held__declared-follow-up-and-censoring__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
