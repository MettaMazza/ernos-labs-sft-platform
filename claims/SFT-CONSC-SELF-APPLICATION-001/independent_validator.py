"""Implementation-distinct product validator for SFT-CONSC-SELF-APPLICATION-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-CONSC-SELF-APPLICATION-001'
DOMAINS = (('carrier-absent-or-description-only', 'self-model-and-model-operation'), ('distinction-collapsed-or-conflated', 'model/input'), ('operation-imported-fitted-or-missing', 'operation-applied-to-own-output'), ('favourable-output-without-complete-trace', 'application-trace'), ('report-behaviour-correlation-or-confidence-substituted', 'formal-computational'), ('prior-consensus-target-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-instance-with-erased-alternatives', 'positive-finite-successor-with-all-alternatives'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'self-model-and-model-operation__model/input__operation-applied-to-own-output__application-trace__formal-computational__root-bound-forward-forcing__positive-finite-successor-with-all-alternatives__no-extra-rule'
def main():
