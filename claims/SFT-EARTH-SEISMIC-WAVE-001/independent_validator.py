"""Implementation-distinct product validator for SFT-EARTH-SEISMIC-WAVE-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-SEISMIC-WAVE-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'source-medium-receiver-carrier'), ('boundary-or-interface-erased', 'network-resolution-bounded'), ('imported-fitted-or-missing-relation', 'source-to-receiver-propagation-relation'), ('favourable-output-with-incomplete-record', 'phase-path-time-instrument-and-uncertainty-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'source-medium-receiver-carrier__network-resolution-bounded__source-to-receiver-propagation-relation__phase-path-time-instrument-and-uncertainty-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
