"""Official execution binding for SFT-CHEM-CONFORMER-GENERATION-EQUIVALENCE-005."""
...
def build_execution(root:Path)->ClaimExecution:
 ...
 files=(root/"sft/chemistry/conformer_generation_equivalence_law_v1.py",root/"sft/chemistry/conformer_generation_equivalence_batch_v1.py",
  ...
  root/TARGET_PATH,root/PRIMARY_PATH,*(root/path for path in snapshots),root/"claims/SFT-CHEM-CONFORMER-GENERATION-EQUIVALENCE-005/execution.py")
 files=tuple(dict.fromkeys(files));source_hash=build_source_manifest(root,files).manifest_hash;independent=root/"claims/SFT-CHEM-CONFORMER-GENERATION-EQUIVALENCE-005/independent_validator.py"
