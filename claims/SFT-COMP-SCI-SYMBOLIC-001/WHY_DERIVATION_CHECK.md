# Fold scientific symbolic-computation law
...
> The structural One supplies one canonical exact model-expression transformation form with its identity trace and no unrecorded predecessor.

Depth-independent successor:

> Appending one generated exact model-expression transformation form adds its exact carrier row, relations, trace positions and new pair/interface distinctions while preserving every earlier record.
...
- `scientific_computation-witness-1` — scientific_computation exact operational witness 1 for SFT-COMP-SCI-SYMBOLIC-001
- `scientific_computation-witness-2` — scientific_computation exact operational witness 2 for SFT-COMP-SCI-SYMBOLIC-001
- `scientific_computation-witness-3` — scientific_computation exact operational witness 3 for SFT-COMP-SCI-SYMBOLIC-001
...
Conventional terms are downstream correspondence only: symbolic scientific computing, computer algebra.
