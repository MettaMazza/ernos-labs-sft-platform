"""Implementation-distinct product validator for SFT-CONSC-FIRST-THIRD-PERSON-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-CONSC-FIRST-THIRD-PERSON-001'
DOMAINS = (('carrier-absent-or-description-only', 'paired-interior-and-external-records'), ('distinction-collapsed-or-conflated', 'experienced/observed'), ('operation-imported-fitted-or-missing', 'provenance-preserving-pairing'), ('favourable-output-without-complete-trace', 'participant-observer-method'), ('report-behaviour-correlation-or-confidence-substituted', 'evidence-class-separation'), ('prior-consensus-target-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-instance-with-erased-alternatives', 'positive-finite-successor-with-all-alternatives'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'paired-interior-and-external-records__experienced/observed__provenance-preserving-pairing__participant-observer-method__evidence-class-separation__root-bound-forward-forcing__positive-finite-successor-with-all-alternatives__no-extra-rule'
def main():
