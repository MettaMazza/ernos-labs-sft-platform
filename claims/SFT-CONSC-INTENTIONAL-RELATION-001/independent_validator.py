"""Implementation-distinct product validator for SFT-CONSC-INTENTIONAL-RELATION-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-CONSC-INTENTIONAL-RELATION-001'
DOMAINS = (('carrier-absent-or-description-only', 'representation-and-referent-class'), ('distinction-collapsed-or-conflated', 'aboutness/coincidence'), ('operation-imported-fitted-or-missing', 'source-bound-reference'), ('favourable-output-without-complete-trace', 'reference-and-error-cases'), ('report-behaviour-correlation-or-confidence-substituted', 'behavioural-and-semantic'), ('prior-consensus-target-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-instance-with-erased-alternatives', 'positive-finite-successor-with-all-alternatives'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'representation-and-referent-class__aboutness/coincidence__source-bound-reference__reference-and-error-cases__behavioural-and-semantic__root-bound-forward-forcing__positive-finite-successor-with-all-alternatives__no-extra-rule'
def main():
