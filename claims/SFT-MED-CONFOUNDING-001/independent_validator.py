"""Implementation-distinct product validator for SFT-MED-CONFOUNDING-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-CONFOUNDING-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'exposure-outcome-common-cause-word'), ('relation-imported-fitted-or-erased', 'common-cause-distortion-relation'), ('organization-collapsed', 'measured-and-unmeasured-support'), ('observation-boundary-unrecorded', 'design-and-adjustment-boundary'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'exposure-outcome-common-cause-word__common-cause-distortion-relation__measured-and-unmeasured-support__design-and-adjustment-boundary__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
