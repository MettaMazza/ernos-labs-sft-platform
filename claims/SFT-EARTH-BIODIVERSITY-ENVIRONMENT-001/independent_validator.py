"""Implementation-distinct product validator for SFT-EARTH-BIODIVERSITY-ENVIRONMENT-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-BIODIVERSITY-ENVIRONMENT-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'taxon-trait-habitat-pressure-carrier'), ('boundary-or-interface-erased', 'study-design-bounded'), ('imported-fitted-or-missing-relation', 'environmental-condition-to-biological-response-comparison'), ('favourable-output-with-incomplete-record', 'sampling-taxonomy-space-time-confounders-and-missingness-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'taxon-trait-habitat-pressure-carrier__study-design-bounded__environmental-condition-to-biological-response-comparison__sampling-taxonomy-space-time-confounders-and-missingness-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
