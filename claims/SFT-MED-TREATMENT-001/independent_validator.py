"""Implementation-distinct product validator for SFT-MED-TREATMENT-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-TREATMENT-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'patient-with-declared-condition'), ('relation-imported-fitted-or-erased', 'therapeutic-action-to-course'), ('organization-collapsed', 'content-delivery-response-and-harm'), ('observation-boundary-unrecorded', 'indication-setting-time-and-follow-up'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'patient-with-declared-condition__therapeutic-action-to-course__content-delivery-response-and-harm__indication-setting-time-and-follow-up__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
