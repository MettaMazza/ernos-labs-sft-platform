"""Implementation-distinct product validator for SFT-EARTH-GROUNDWATER-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-GROUNDWATER-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'subsurface-water-material-carrier'), ('boundary-or-interface-erased', 'aquifer-observation-bounded'), ('imported-fitted-or-missing-relation', 'storage-gradient-path-and-exchange-relation'), ('favourable-output-with-incomplete-record', 'porosity-composition-boundaries-recharge-discharge-and-time-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'subsurface-water-material-carrier__aquifer-observation-bounded__storage-gradient-path-and-exchange-relation__porosity-composition-boundaries-recharge-discharge-and-time-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
