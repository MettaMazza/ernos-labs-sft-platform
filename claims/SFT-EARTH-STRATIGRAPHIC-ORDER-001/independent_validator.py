"""Implementation-distinct product validator for SFT-EARTH-STRATIGRAPHIC-ORDER-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-STRATIGRAPHIC-ORDER-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'ordered-layer-event-carrier'), ('boundary-or-interface-erased', 'section-and-correlation-bounded'), ('imported-fitted-or-missing-relation', 'before-after-and-correlation-relation'), ('favourable-output-with-incomplete-record', 'contacts-unconformities-intrusions-faults-and-dates-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'ordered-layer-event-carrier__section-and-correlation-bounded__before-after-and-correlation-relation__contacts-unconformities-intrusions-faults-and-dates-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
