# Entanglement and no-signalling boundary

Claim: `SFT-PHYS-QUANTUM-NO-SIGNALLING-001`
...
`complete-fold-carrier__remote-fibre-relabeling-invariant-local-count__source-bound-proof-trace__capability-closed-prediction__separate-measurement-record__complete-registered-rows__one-successor-closure__no-extra-rule`
