"""Implementation-distinct product validator for SFT-EARTH-STOCK-FLOW-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-STOCK-FLOW-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'reservoir-stock-interface-flow-carrier'), ('boundary-or-interface-erased', 'quantity-and-interval-bounded'), ('imported-fitted-or-missing-relation', 'time-integrated-transfer-relation'), ('favourable-output-with-incomplete-record', 'stock-basis-flow-interval-and-boundary-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'reservoir-stock-interface-flow-carrier__quantity-and-interval-bounded__time-integrated-transfer-relation__stock-basis-flow-interval-and-boundary-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
