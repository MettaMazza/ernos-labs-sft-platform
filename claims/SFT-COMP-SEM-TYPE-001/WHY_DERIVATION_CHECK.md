...
> The structural One supplies one canonical structural admissibility of composition form with its identity trace and no unrecorded predecessor.

Depth-independent successor:

> Appending one generated structural admissibility of composition form adds its exact carrier row, relations, trace positions and new pair/interface distinctions while preserving every earlier record.
...
- `semantics-witness-1` — semantics exact operational witness 1 for SFT-COMP-SEM-TYPE-001
- `semantics-witness-2` — semantics exact operational witness 2 for SFT-COMP-SEM-TYPE-001
- `semantics-witness-3` — semantics exact operational witness 3 for SFT-COMP-SEM-TYPE-001
...
Conventional terms are downstream correspondence only: type theory, type safety.
