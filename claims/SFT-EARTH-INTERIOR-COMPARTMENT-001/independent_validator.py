"""Implementation-distinct product validator for SFT-EARTH-INTERIOR-COMPARTMENT-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-INTERIOR-COMPARTMENT-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'nested-interior-region-carrier'), ('boundary-or-interface-erased', 'geophysical-inference-bounded'), ('imported-fitted-or-missing-relation', 'boundary-and-property-contrast-relation'), ('favourable-output-with-incomplete-record', 'depth-composition-state-observation-and-uncertainty-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'nested-interior-region-carrier__geophysical-inference-bounded__boundary-and-property-contrast-relation__depth-composition-state-observation-and-uncertainty-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
