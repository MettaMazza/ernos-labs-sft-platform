"""Implementation-distinct product validator for SFT-MED-DECISION-CAPACITY-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-DECISION-CAPACITY-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'person-decision-context'), ('relation-imported-fitted-or-erased', 'understand-retain-weigh-communicate'), ('organization-collapsed', 'decision-specific-support-and-assistance'), ('observation-boundary-unrecorded', 'time-decision-and-assessment-method'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'person-decision-context__understand-retain-weigh-communicate__decision-specific-support-and-assistance__time-decision-and-assessment-method__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
