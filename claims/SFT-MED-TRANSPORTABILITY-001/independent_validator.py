"""Implementation-distinct product validator for SFT-MED-TRANSPORTABILITY-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-TRANSPORTABILITY-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'source-and-target-populations'), ('relation-imported-fitted-or-erased', 'invariant-and-different-features'), ('organization-collapsed', 'joint-population-treatment-outcome'), ('observation-boundary-unrecorded', 'setting-time-and-care-system'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'source-and-target-populations__invariant-and-different-features__joint-population-treatment-outcome__setting-time-and-care-system__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
