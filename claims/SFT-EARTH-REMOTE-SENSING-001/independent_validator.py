"""Implementation-distinct product validator for SFT-EARTH-REMOTE-SENSING-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-REMOTE-SENSING-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'source-path-sensor-retrieval-carrier'), ('boundary-or-interface-erased', 'sensor-product-bounded'), ('imported-fitted-or-missing-relation', 'signal-to-geophysical-record-relation'), ('favourable-output-with-incomplete-record', 'geometry-spectrum-calibration-processing-validation-and-cloud-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'source-path-sensor-retrieval-carrier__sensor-product-bounded__signal-to-geophysical-record-relation__geometry-spectrum-calibration-processing-validation-and-cloud-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
