"""Implementation-distinct product validator for SFT-EARTH-WEATHER-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-WEATHER-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'finite-time-atmospheric-state-carrier'), ('boundary-or-interface-erased', 'forecast-horizon-bounded'), ('imported-fitted-or-missing-relation', 'state-transition-and-observation-relation'), ('favourable-output-with-incomplete-record', 'initial-state-forcing-resolution-ensemble-and-outcomes-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'finite-time-atmospheric-state-carrier__forecast-horizon-bounded__state-transition-and-observation-relation__initial-state-forcing-resolution-ensemble-and-outcomes-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
