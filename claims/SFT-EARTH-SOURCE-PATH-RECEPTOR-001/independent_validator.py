"""Implementation-distinct product validator for SFT-EARTH-SOURCE-PATH-RECEPTOR-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-SOURCE-PATH-RECEPTOR-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'source-medium-path-receptor-carrier'), ('boundary-or-interface-erased', 'system-and-study-bounded'), ('imported-fitted-or-missing-relation', 'causal-transfer-chain'), ('favourable-output-with-incomplete-record', 'identity-route-timing-transformation-exposure-and-controls-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'source-medium-path-receptor-carrier__system-and-study-bounded__causal-transfer-chain__identity-route-timing-transformation-exposure-and-controls-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
