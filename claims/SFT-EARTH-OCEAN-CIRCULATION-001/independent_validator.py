"""Implementation-distinct product validator for SFT-EARTH-OCEAN-CIRCULATION-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-OCEAN-CIRCULATION-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'water-mass-pathway-network'), ('boundary-or-interface-erased', 'basin-time-window-bounded'), ('imported-fitted-or-missing-relation', 'transport-overturning-and-mixing-relation'), ('favourable-output-with-incomplete-record', 'mass-properties-direction-depth-time-and-boundaries-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'water-mass-pathway-network__basin-time-window-bounded__transport-overturning-and-mixing-relation__mass-properties-direction-depth-time-and-boundaries-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
