"""Implementation-distinct product validator for SFT-MED-DOSE-RESPONSE-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-DOSE-RESPONSE-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'ordered-dose-groups-and-outcomes'), ('relation-imported-fitted-or-erased', 'outcome-incidence-by-dose'), ('organization-collapsed', 'complete-dose-support-with-adverse-shapes'), ('observation-boundary-unrecorded', 'population-route-and-time'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'ordered-dose-groups-and-outcomes__outcome-incidence-by-dose__complete-dose-support-with-adverse-shapes__population-route-and-time__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
