"""Standalone regeneration of the exact-part coordinate grammar."""
...
DOMAINS = (
    ...
    ("unequal", "equal"),
    ("empty", "within", "outside"),
    ("held-absent", "held-present"),
    ("whole-absent", "whole-present"),
    ("no-extra", "has-extra"),
)
SURVIVOR = (
...
def main():
    ...
    passed = (
        sealed["claim_id"] == "SFT-FOUNDATION-PART-001"
