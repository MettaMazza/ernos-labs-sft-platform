"""Implementation-distinct product validator for SFT-MED-COMORBIDITY-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-COMORBIDITY-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'joint-patient-condition-state'), ('relation-imported-fitted-or-erased', 'co-occurrence-with-interaction-held'), ('organization-collapsed', 'noncollapsed-joint-condition-word'), ('observation-boundary-unrecorded', 'shared-patient-and-interval'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'joint-patient-condition-state__co-occurrence-with-interaction-held__noncollapsed-joint-condition-word__shared-patient-and-interval__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
