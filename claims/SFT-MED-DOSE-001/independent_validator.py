"""Implementation-distinct product validator for SFT-MED-DOSE-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-DOSE-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'administered-substance-or-action'), ('relation-imported-fitted-or-erased', 'amount-per-declared-carrier-and-time'), ('organization-collapsed', 'unit-route-formulation-schedule'), ('observation-boundary-unrecorded', 'delivered-and-received-record'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'administered-substance-or-action__amount-per-declared-carrier-and-time__unit-route-formulation-schedule__delivered-and-received-record__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
