"""Implementation-distinct product validator for SFT-MED-EFFECT-MODIFICATION-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-EFFECT-MODIFICATION-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'stratified-patient-carriers'), ('relation-imported-fitted-or-erased', 'contrast-varies-by-held-stratum'), ('organization-collapsed', 'joint-treatment-stratum-outcome'), ('observation-boundary-unrecorded', 'predeclared-strata-and-scale'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'stratified-patient-carriers__contrast-varies-by-held-stratum__joint-treatment-stratum-outcome__predeclared-strata-and-scale__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
