"""Implementation-distinct product validator for SFT-EARTH-VOLCANIC-PROCESS-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-VOLCANIC-PROCESS-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'magma-pathway-eruption-carrier'), ('boundary-or-interface-erased', 'volcanic-system-bounded'), ('imported-fitted-or-missing-relation', 'generation-storage-transport-release-transition'), ('favourable-output-with-incomplete-record', 'composition-pressure-geometry-time-products-and-failures-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'magma-pathway-eruption-carrier__volcanic-system-bounded__generation-storage-transport-release-transition__composition-pressure-geometry-time-products-and-failures-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
