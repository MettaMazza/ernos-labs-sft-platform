"""Implementation-distinct product validator for SFT-MED-DIAGNOSTIC-CLASSIFICATION-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-DIAGNOSTIC-CLASSIFICATION-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'patient-evidence-word'), ('relation-imported-fitted-or-erased', 'criteria-to-class-relation'), ('organization-collapsed', 'classification-with-alternatives-held'), ('observation-boundary-unrecorded', 'reference-standard-and-verification'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'patient-evidence-word__criteria-to-class-relation__classification-with-alternatives-held__reference-standard-and-verification__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
