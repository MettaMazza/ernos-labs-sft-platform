"""Implementation-distinct product validator for SFT-CONSC-INTROSPECTION-BLIND-SPOT-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-CONSC-INTROSPECTION-BLIND-SPOT-001'
DOMAINS = (('carrier-absent-or-description-only', 'two-preimage-observation-class'), ('distinction-collapsed-or-conflated', 'predecessor/image'), ('operation-imported-fitted-or-missing', 'unretained-fibre-closure'), ('favourable-output-without-complete-trace', 'missing-fibre-explicit'), ('report-behaviour-correlation-or-confidence-substituted', 'formal-and-report'), ('prior-consensus-target-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-instance-with-erased-alternatives', 'positive-finite-successor-with-all-alternatives'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'two-preimage-observation-class__predecessor/image__unretained-fibre-closure__missing-fibre-explicit__formal-and-report__root-bound-forward-forcing__positive-finite-successor-with-all-alternatives__no-extra-rule'
def main():
