"""Implementation-distinct product validator for SFT-EARTH-EARTH-SYSTEM-TIPPING-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-EARTH-SYSTEM-TIPPING-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'multi-basin-state-forcing-carrier'), ('boundary-or-interface-erased', 'system-proxy-and-timescale-bounded'), ('imported-fitted-or-missing-relation', 'threshold-crossing-hysteresis-and-return-relation'), ('favourable-output-with-incomplete-record', 'state-variable-driver-path-rate-controls-and-time-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'multi-basin-state-forcing-carrier__system-proxy-and-timescale-bounded__threshold-crossing-hysteresis-and-return-relation__state-variable-driver-path-rate-controls-and-time-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
