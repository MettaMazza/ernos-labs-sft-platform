"""Implementation-distinct product validator for SFT-MED-ADHERENCE-CROSSOVER-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-ADHERENCE-CROSSOVER-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'assigned-and-received-care-record'), ('relation-imported-fitted-or-erased', 'assignment-delivery-use-relation'), ('organization-collapsed', 'protocol-deviation-trace'), ('observation-boundary-unrecorded', 'participant-time-and-reason'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'assigned-and-received-care-record__assignment-delivery-use-relation__protocol-deviation-trace__participant-time-and-reason__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
