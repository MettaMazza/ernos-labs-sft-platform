"""Implementation-distinct product validator for SFT-CONSC-QUALITATIVE-IDENTITY-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-CONSC-QUALITATIVE-IDENTITY-001'
DOMAINS = (('carrier-absent-or-description-only', 'reidentified-interior-content'), ('distinction-collapsed-or-conflated', 'same-quality/similar-quality'), ('operation-imported-fitted-or-missing', 'cross-instance-identity-judgment'), ('favourable-output-without-complete-trace', 'participant-context-and-controls'), ('report-behaviour-correlation-or-confidence-substituted', 'first-person-psychophysical'), ('prior-consensus-target-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-instance-with-erased-alternatives', 'positive-finite-successor-with-all-alternatives'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'reidentified-interior-content__same-quality/similar-quality__cross-instance-identity-judgment__participant-context-and-controls__first-person-psychophysical__root-bound-forward-forcing__positive-finite-successor-with-all-alternatives__no-extra-rule'
def main():
