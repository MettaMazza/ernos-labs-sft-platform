"""Implementation-distinct product validator for SFT-MED-CLINICAL-OBSERVATION-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-CLINICAL-OBSERVATION-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'patient-state-and-observer-record'), ('relation-imported-fitted-or-erased', 'observation-with-retained-method'), ('organization-collapsed', 'source-method-result-provenance'), ('observation-boundary-unrecorded', 'declared-observer-instrument-setting-time'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
