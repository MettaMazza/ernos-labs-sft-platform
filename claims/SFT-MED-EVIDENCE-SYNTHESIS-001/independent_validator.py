"""Implementation-distinct product validator for SFT-MED-EVIDENCE-SYNTHESIS-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-EVIDENCE-SYNTHESIS-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'study-level-evidence-carriers'), ('relation-imported-fitted-or-erased', 'question-matched-composition'), ('organization-collapsed', 'heterogeneity-bias-and-dependence-held'), ('observation-boundary-unrecorded', 'protocol-search-selection-and-date'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'study-level-evidence-carriers__question-matched-composition__heterogeneity-bias-and-dependence-held__protocol-search-selection-and-date__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
