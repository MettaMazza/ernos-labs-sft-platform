"""Implementation-distinct product validator for SFT-MED-CLINICAL-ASSOCIATION-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-CLINICAL-ASSOCIATION-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'paired-exposure-outcome-records'), ('relation-imported-fitted-or-erased', 'joint-incidence-relation'), ('organization-collapsed', 'strata-and-missingness-held'), ('observation-boundary-unrecorded', 'population-time-and-selection'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'paired-exposure-outcome-records__joint-incidence-relation__strata-and-missingness-held__population-time-and-selection__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
