"""Implementation-distinct product validator for SFT-MED-SEVERITY-STAGE-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-SEVERITY-STAGE-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'disease-or-injury-course'), ('relation-imported-fitted-or-erased', 'ordered-extent-relation'), ('organization-collapsed', 'criteria-specific-partial-order'), ('observation-boundary-unrecorded', 'method-time-and-organ-system'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'disease-or-injury-course__ordered-extent-relation__criteria-specific-partial-order__method-time-and-organ-system__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
