"""Implementation-distinct product validator for SFT-MED-INJURY-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-INJURY-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'patient-tissue-or-function-state'), ('relation-imported-fitted-or-erased', 'damage-following-declared-exposure'), ('organization-collapsed', 'exposure-damage-consequence-trace'), ('observation-boundary-unrecorded', 'site-time-severity-method'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'patient-tissue-or-function-state__damage-following-declared-exposure__exposure-damage-consequence-trace__site-time-severity-method__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
