"""Implementation-distinct product validator for SFT-EARTH-MOISTURE-CLOUD-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-MOISTURE-CLOUD-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'water-vapour-droplet-ice-air-carrier'), ('boundary-or-interface-erased', 'cloud-observation-bounded'), ('imported-fitted-or-missing-relation', 'transport-phase-nucleation-and-precipitation-relation'), ('favourable-output-with-incomplete-record', 'phase-size-location-time-aerosol-and-uncertainty-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'water-vapour-droplet-ice-air-carrier__cloud-observation-bounded__transport-phase-nucleation-and-precipitation-relation__phase-size-location-time-aerosol-and-uncertainty-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
