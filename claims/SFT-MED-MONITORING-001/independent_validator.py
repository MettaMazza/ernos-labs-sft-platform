"""Implementation-distinct product validator for SFT-MED-MONITORING-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-MONITORING-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'ordered-patient-measurements'), ('relation-imported-fitted-or-erased', 'change-to-decision-relation'), ('organization-collapsed', 'schedule-threshold-action-trace'), ('observation-boundary-unrecorded', 'method-interval-and-care-context'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'ordered-patient-measurements__change-to-decision-relation__schedule-threshold-action-trace__method-interval-and-care-context__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
