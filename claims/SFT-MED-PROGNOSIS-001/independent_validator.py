"""Implementation-distinct product validator for SFT-MED-PROGNOSIS-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-MED-PROGNOSIS-001'
DOMAINS = (('carrier-erased-aggregate-or-answer-only', 'patient-baseline-state'), ('relation-imported-fitted-or-erased', 'baseline-to-future-outcome-support'), ('organization-collapsed', 'conditioned-course-alternatives'), ('observation-boundary-unrecorded', 'care-context-horizon-and-censoring'), ('favorable-result-without-complete-record', 'complete-protocol-state-transition-adverse-null-record'), ('authority-consensus-prior-or-target-selected-law', 'root-bound-forward-forcing'), ('single-patient-favorable-study', 'positive-finite-successor-and-unfavorable-closure'), ('free-fit-exception-opaque-model-or-extra-rule', 'no-extra-rule'))
SURVIVOR = 'patient-baseline-state__baseline-to-future-outcome-support__conditioned-course-alternatives__care-context-horizon-and-censoring__complete-protocol-state-transition-adverse-null-record__root-bound-forward-forcing__positive-finite-successor-and-unfavorable-closure__no-extra-rule'
def main():
