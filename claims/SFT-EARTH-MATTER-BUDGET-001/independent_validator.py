"""Implementation-distinct product validator for SFT-EARTH-MATTER-BUDGET-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-MATTER-BUDGET-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'species-resolved-stock-transfer-carrier'), ('boundary-or-interface-erased', 'matter-domain-bounded'), ('imported-fitted-or-missing-relation', 'source-storage-transformation-export-balance'), ('favourable-output-with-incomplete-record', 'species-phase-location-time-and-uncertainty-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'species-resolved-stock-transfer-carrier__matter-domain-bounded__source-storage-transformation-export-balance__species-phase-location-time-and-uncertainty-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
