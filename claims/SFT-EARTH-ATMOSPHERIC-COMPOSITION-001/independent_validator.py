"""Implementation-distinct product validator for SFT-EARTH-ATMOSPHERIC-COMPOSITION-001."""
from itertools import product
import json
import sys
CLAIM_ID = 'SFT-EARTH-ATMOSPHERIC-COMPOSITION-001'
DOMAINS = (('answer-only-or-unbounded-carrier', 'species-aerosol-mixture-carrier'), ('boundary-or-interface-erased', 'sampling-network-bounded'), ('imported-fitted-or-missing-relation', 'amount-fraction-and-transformation-relation'), ('favourable-output-with-incomplete-record', 'species-units-altitude-location-time-and-method-held'), ('model-proxy-forecast-or-observation-conflated', 'evidence-class-explicit'), ('prior-target-consensus-or-application-selected', 'root-bound-forward-forcing'), ('one-favourable-case-with-erased-alternatives', 'positive-finite-successor-retains-all-rows'), ('free-parameter-exception-or-opaque-oracle', 'no-extra-rule'))
SURVIVOR = 'species-aerosol-mixture-carrier__sampling-network-bounded__amount-fraction-and-transformation-relation__species-units-altitude-location-time-and-method-held__evidence-class-explicit__root-bound-forward-forcing__positive-finite-successor-retains-all-rows__no-extra-rule'
def main():
