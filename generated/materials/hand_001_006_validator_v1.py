...
def surface(number):
    relation = "complete-one-owner-root-traced-consumer-graph" if number == "006" else {
        "001": "materials-to-engineering_translation-directed-one-owner-handoff",
        "002": "materials-to-biology-directed-one-owner-handoff",
        "003": "materials-to-medicine-directed-one-owner-handoff",
        "004": "materials-to-earth_environment-directed-one-owner-handoff",
        "005": "materials-to-astronomy_cosmology-directed-one-owner-handoff",
    }[number]
...
def main():
    ...
    registry = json.loads((root / "census/materials_hand_001_006_dependency_registry_v1.json").read_text())
    vector = json.loads((root / "experiments/external_sources/materials/hand_001_006_complete_handoff_vector_v1.json").read_text())
