#!/usr/bin/env python3
"""Independent generated-grammar reconstruction for the Planck vacuum test."""
...
DOMAINS = (
    ...
    ("imported-or-fitted-relation", "sealed-vacuum-density-law-versus-complete-Planck-CODATA-record"),
