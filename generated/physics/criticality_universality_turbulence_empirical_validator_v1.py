#!/usr/bin/env python3
"""Independent enumeration of the criticality/turbulence empirical claim."""
...
DOMAINS = (
    ...
    ("imported-or-fitted-relation", "sealed-criticality-and-cascade-law-versus-complete-postseal-exponent-and-turbulence-vector"),
        ...
        json.dumps(
            {
                ...
                "certificate": {
                    "candidate_count": 256,
                    "registered_target_rows": 4,
                    "manganite_sample_rows": 5,
