#!/usr/bin/env python3
"""Independent complete enumeration for empirical vacuum/inertia Claim 087."""
...
DOMAINS = (
    ...
    ("imported-or-fitted-relation", "sealed-vacuum-inertia-drive-family-versus-complete-five-source-observation-vector"),
