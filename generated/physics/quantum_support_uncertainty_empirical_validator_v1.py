#!/usr/bin/env python3
"""Independent enumeration of the quantum-support Bell empirical claim."""
...
DOMAINS = (
    ...
    ("imported-or-fitted-relation", "sealed-local-factorization-law-versus-complete-superconducting-circuit-Bell-record"),
