#!/usr/bin/env python3
"""Independent generated-grammar reconstruction for the spectrum comparison."""
...
DOMAINS = (
    ...
    ("imported-or-fitted-relation", "positive-colour-singlet-gap-with-complete-spectrum-scope"),
