...
DOMAINS = (
    ...
    ("imported-or-fitted-relation", "sealed-physical-thermal-values-versus-complete-measurements"),
...
def main():
    ...
    print(json.dumps({"passed": passed, "validated_seal_hash": sealed["seal_hash"], "recomputed_from_declared_inputs": True, "certificate": {"candidate_count": 256, "registered_target_rows": 6, "primary_source_count": 6, "target_content_used": False, "survivor": "__".join(SURVIVOR)}}, sort_keys=True))
