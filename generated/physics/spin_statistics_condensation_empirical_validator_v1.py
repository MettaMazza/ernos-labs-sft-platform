#!/usr/bin/env python3
"""Independent enumeration of the spin-statistics empirical claim."""
...
DOMAINS = (
    ...
    ("imported-or-fitted-relation", "sealed-spin-statistics-condensation-law-versus-complete-finite-BEC-Pauli-and-spinor-vector"),
