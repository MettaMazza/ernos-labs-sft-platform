#!/usr/bin/env python3
"""Independent generated-grammar reconstruction for the thermal-history test."""
...
DOMAINS = (
    ...
    ("imported-or-fitted-relation", "sealed-thermal-history-law-versus-complete-primary-observation-record"),
...
def main() -> None:
    ...
    print(json.dumps({
        ...
        "certificate": {
            ...
            "registered_target_rows": 6,
            "primary_source_count": 5,
            "authoritative_synthesis_count": 1,
            "unfavourable_helium_row_retained": True,
