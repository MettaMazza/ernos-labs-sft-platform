...
DOMAINS = (
    ...
    ("imported-or-fitted-relation", "sealed-exact-regge-carriers-versus-complete-measured-resonance-supports"),
...
def main():
    ...
    print(json.dumps({"passed": passed, "validated_seal_hash": sealed["seal_hash"], "recomputed_from_declared_inputs": True, "certificate": {"candidate_count": 256, "registered_target_rows": 5, "primary_source_count": 5, "target_content_used": False, "survivor": "__".join(SURVIVOR)}}, sort_keys=True))
