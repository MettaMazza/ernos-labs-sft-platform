#!/usr/bin/env python3
"""Independent enumeration of the particle-mode empirical claim."""
...
DOMAINS = (
    ...
    ("imported-or-fitted-relation", "sealed-particle-mode-generation-law-versus-complete-registered-spectrum-vector"),
...
def main():
    ...
    print(json.dumps({"passed": passed, "validated_seal_hash": sealed["seal_hash"], "recomputed_from_declared_inputs": True, "certificate": {"candidate_count": 256, "registered_target_rows": 7, "primary_source_count": 5, "target_content_used": False, "survivor": "__".join(SURVIVOR)}}, sort_keys=True))
