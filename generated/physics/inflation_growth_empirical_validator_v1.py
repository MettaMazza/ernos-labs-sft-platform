#!/usr/bin/env python3
"""Independent generated-grammar reconstruction for inflation-growth testing."""
...
DOMAINS = (
    ...
    ("imported-or-fitted-relation", "sealed-inflation-growth-law-versus-complete-scalar-index-and-tensor-bound-record"),
...
def main() -> None:
    ...
    passed = all((
        ...
        decisions == recomputed, sum(recomputed.values()) == 1,
    ...
    print(json.dumps({
        "passed": passed, "validated_seal_hash": sealed["seal_hash"], "recomputed_from_declared_inputs": True,
        "certificate": {"candidate_count": len(generated), "registered_target_rows": 2, "primary_source_count": 2, "target_content_used": False, "survivor": "__".join(SURVIVOR)},
    }, sort_keys=True))
