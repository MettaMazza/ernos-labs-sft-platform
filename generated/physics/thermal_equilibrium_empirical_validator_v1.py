#!/usr/bin/env python3
"""Independent enumeration of the thermal-equilibrium empirical claim."""
...
DOMAINS = (
    ...
    ("imported-or-fitted-relation", "sealed-thermal-law-versus-complete-acoustic-and-Johnson-noise-vector"),
