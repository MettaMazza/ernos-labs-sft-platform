...
from sft.information_science.hand_001_006_external_v1 import load
from sft.information_science.hand_001_006_laws_v1 import IDS, OBS, SPECS
...
def test_registry_and_vector_order():
    ...
    assert len(registry["claim_ids"]) == vector["record_count"] == 6
