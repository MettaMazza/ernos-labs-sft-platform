...
from sft.chemistry.echem_polarization_batch_v1 import SPECS
from sft.chemistry.echem_polarization_validation_v1 import exact_analysis

ROOT = Path(__file__).resolve().parents[1]


@pytest.mark.parametrize("claim", SPECS, ids=("echem009", "echem010", "echem011", "echem012"))
...
def test_complete_external_reconstruction(claim):
    ...
    assert analysis["complete_family_pdf_characters"] == 156376
