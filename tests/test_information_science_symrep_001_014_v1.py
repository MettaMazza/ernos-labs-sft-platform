...
from sft.information_science.symrep_001_014_external_v1 import load
from sft.information_science.symrep_001_014_laws_v1 import IDS, OBS, SPECS
...
def test_registry_and_vector_order():
    ...
    assert len(registry["claim_ids"]) == vector["record_count"] == 14
...
def test_all_rows_and_sources_are_preserved():
