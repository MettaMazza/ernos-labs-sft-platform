...
from sft.mathematics.valid_001_012_external_v1 import load
from sft.mathematics.valid_001_012_laws_v1 import IDS,OBS,SPECS
...
def test_registry_vector():
 r,v=load(ROOT);assert r["target_content_present"] is False;assert len(r["claim_ids"])==v["record_count"]==12;assert v["outcomes_opened_only_after_registry_freeze"] and v["boundary_record_count"]==305
