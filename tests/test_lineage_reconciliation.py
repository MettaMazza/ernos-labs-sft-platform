...
class LineageReconciliationTests(unittest.TestCase):
    ...
    def test_missing_lineage_work_is_blocking_not_historical_completion(self) -> None:
        ...
        self.assertEqual(self.registry["v2_step_census"]["explicitly_mapped_steps"], 118)
        self.assertEqual(self.registry["v2_step_census"]["unmapped_steps"], 289)
        ...
        self.assertEqual(self.registry["v1_manifest_census"]["explicitly_mapped_rows"], 8)
        self.assertEqual(self.registry["v1_manifest_census"]["unmapped_rows"], 348)
