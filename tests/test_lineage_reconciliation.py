...
class LineageReconciliationTests(unittest.TestCase):
    ...
    def test_missing_lineage_work_is_blocking_not_historical_completion(self) -> None:
        ...
        self.assertEqual(self.registry["v2_step_census"]["explicitly_mapped_steps"], 117)
        self.assertEqual(self.registry["v2_step_census"]["unmapped_steps"], 290)
        ...
        self.assertEqual(self.registry["v1_manifest_census"]["explicitly_mapped_rows"], 7)
        self.assertEqual(self.registry["v1_manifest_census"]["unmapped_rows"], 349)
