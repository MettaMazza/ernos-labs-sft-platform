...
class LineageReconciliationTests(unittest.TestCase):
    ...
    def test_missing_lineage_work_is_blocking_not_historical_completion(self) -> None:
        ...
        self.assertEqual(self.registry["v2_step_census"]["explicitly_mapped_steps"], 121)
        self.assertEqual(self.registry["v2_step_census"]["unmapped_steps"], 286)
        ...
        self.assertEqual(self.registry["v1_manifest_census"]["explicitly_mapped_rows"], 10)
        self.assertEqual(self.registry["v1_manifest_census"]["unmapped_rows"], 346)
