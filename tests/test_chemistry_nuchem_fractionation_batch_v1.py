...
from sft.chemistry.nuchem_fractionation_batch_v1 import SPECS
...
@pytest.mark.parametrize("claim", SPECS, ids=("nuchem005", "nuchem006", "nuchem007", "nuchem008"))
...
def test_complete_external_reconstruction(claim):
    ...
    assert analysis["complete_family_pdf_pages"] == 266
    assert analysis["complete_family_html_documents"] == 1
    assert analysis["complete_family_characters"] == 410095
