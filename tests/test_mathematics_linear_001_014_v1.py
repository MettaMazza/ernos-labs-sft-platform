...
from sft.mathematics.linear_001_014_external_v1 import load
from sft.mathematics.linear_001_014_laws_v1 import IDS,OBS,SPECS
...
def test_registry_vector():
 r,v=load(ROOT);assert r["target_content_present"] is False;assert len(r["claim_ids"])==v["record_count"]==14;assert v["outcomes_opened_only_after_registry_freeze"]
