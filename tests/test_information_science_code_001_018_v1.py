...
from sft.information_science.code_001_018_external_v1 import load
from sft.information_science.code_001_018_laws_v1 import IDS, OBS, SPECS
...
def test_registry_and_vector_order():
    ...
    assert len(registry["claim_ids"]) == vector["record_count"] == 18
