...
from sft.chemistry.nuchem_terminal_batch_v1 import SPECS
...
@pytest.mark.parametrize("claim", SPECS, ids=("nuchem009", "nuchem010", "nuchem011", "nuchem012"))
...
def test_complete_external_reconstruction(claim):
    ...
    assert analysis["complete_family_pdf_pages"] == 370
    assert analysis["complete_family_characters"] == 837013
