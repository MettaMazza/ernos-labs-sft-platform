"""Execution assembly for Materials PHASE-001--010."""
...
from sft.materials.phase_001_010_external_v1 import MANIFEST, REGISTRY, VECTOR, PhaseExternalValidator
from sft.materials.phase_001_010_laws_v1 import PhaseProgram, SPECS
...
def build_execution(root: Path, claim_id: str, execution_file: Path):
    ...
    fixed = (root / "sft/materials/phase_001_010_laws_v1.py", root / "sft/materials/phase_001_010_external_v1.py", root / "sft/materials/phase_001_010_execution_v1.py", root / "sft/physics/structural_constants.py", root / REGISTRY, root / MANIFEST, root / VECTOR, execution_file)
    ...
    validator = root / "generated/materials/phase_001_010_validator_v1.py"
    independent = ExternalCommandValidator("sft-materials-phase-001-010-independent-python/1", (sys.executable, str(validator), claim_id, str(root)), validator.parent, (validator,))
    return ClaimExecution(PhaseProgram(spec, source_hash), independent, source_files, PhaseExternalValidator(root, spec))
