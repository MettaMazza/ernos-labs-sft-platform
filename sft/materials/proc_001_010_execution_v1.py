"""Official execution assembly for Materials PROC-001--010."""
...
from sft.materials.proc_001_010_external_v1 import MANIFEST, REGISTRY, VECTOR, ProcExternalValidator
from sft.materials.proc_001_010_laws_v1 import SPECS, ProcProgram
...
def build_execution(root, claim_id, execution_file):
    ...
    fixed = (
        root / "sft/materials/proc_001_010_laws_v1.py",
        root / "sft/materials/proc_001_010_external_v1.py",
        root / "sft/materials/proc_001_010_execution_v1.py",
    ...
    validator = root / "generated/materials/proc_001_010_validator_v1.py"
    independent = ExternalCommandValidator("sft-materials-proc-001-010-independent-python/1", (sys.executable, str(validator), claim_id, str(root)), validator.parent, (validator,))
    return ClaimExecution(ProcProgram(spec, source_hash), independent, files, ProcExternalValidator(root, spec))
