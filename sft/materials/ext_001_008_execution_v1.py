"""Official execution assembly for Materials EXT-001--008."""
...
from sft.materials.ext_001_008_external_v1 import MANIFEST, REGISTRY, VECTOR, ExtExternalValidator
from sft.materials.ext_001_008_laws_v1 import SPECS, ExtProgram
...
def build_execution(root, claim_id, execution_file):
    ...
    fixed = (
        root / "sft/materials/ext_001_008_laws_v1.py",
        root / "sft/materials/ext_001_008_external_v1.py",
        root / "sft/materials/ext_001_008_execution_v1.py",
    ...
    validator = root / "generated/materials/ext_001_008_validator_v1.py"
    independent = ExternalCommandValidator("sft-materials-ext-001-008-independent-python/1", (sys.executable, str(validator), claim_id, str(root)), validator.parent, (validator,))
    return ClaimExecution(ExtProgram(spec, source_hash), independent, files, ExtExternalValidator(root, spec))
