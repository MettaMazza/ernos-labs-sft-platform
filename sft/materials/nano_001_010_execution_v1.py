"""Official execution assembly for Materials NANO-001--010."""
...
from sft.materials.nano_001_010_external_v1 import MANIFEST, REGISTRY, VECTOR, NanoExternalValidator
from sft.materials.nano_001_010_laws_v1 import SPECS, NanoProgram
...
def build_execution(root, claim_id, execution_file):
    ...
    fixed = (
        root / "sft/materials/nano_001_010_laws_v1.py",
        root / "sft/materials/nano_001_010_external_v1.py",
        root / "sft/materials/nano_001_010_execution_v1.py",
    ...
    validator = root / "generated/materials/nano_001_010_validator_v1.py"
    independent = ExternalCommandValidator("sft-materials-nano-001-010-independent-python/1", (sys.executable, str(validator), claim_id, str(root)), validator.parent, (validator,))
    return ClaimExecution(NanoProgram(spec, source_hash), independent, files, NanoExternalValidator(root, spec))
