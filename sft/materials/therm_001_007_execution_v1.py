"""Official execution assembly for Materials THERM-001--007."""
import json
import sys

from sft.engine import ExternalCommandValidator
from sft.engine.source import build_source_manifest
from sft.materials.therm_001_007_external_v1 import MANIFEST, REGISTRY, VECTOR, ThermExternalValidator
from sft.materials.therm_001_007_laws_v1 import SPECS, ThermProgram
...
def build_execution(root, claim_id, execution_file):
    ...
    fixed = (root / "sft/materials/therm_001_007_laws_v1.py", root / "sft/materials/therm_001_007_external_v1.py", root / "sft/materials/therm_001_007_execution_v1.py", root / "sft/physics/structural_constants.py", root / REGISTRY, root / MANIFEST, root / VECTOR, execution_file)
    ...
    validator = root / "generated/materials/therm_001_007_validator_v1.py"
    independent = ExternalCommandValidator("sft-materials-therm-001-007-independent-python/1", (sys.executable, str(validator), claim_id, str(root)), validator.parent, (validator,))
    return ClaimExecution(ThermProgram(spec, source_hash), independent, files, ThermExternalValidator(root, spec))
