"""Official execution assembly for Materials DEGR-001--010."""
...
from sft.materials.degr_001_010_external_v1 import MANIFEST, REGISTRY, VECTOR, DegrExternalValidator
from sft.materials.degr_001_010_laws_v1 import SPECS, DegrProgram
...
def build_execution(root, claim_id, execution_file):
    ...
    fixed = (
        root / "sft/materials/degr_001_010_laws_v1.py",
        root / "sft/materials/degr_001_010_external_v1.py",
        root / "sft/materials/degr_001_010_execution_v1.py",
    ...
    validator = root / "generated/materials/degr_001_010_validator_v1.py"
    independent = ExternalCommandValidator("sft-materials-degr-001-010-independent-python/1", (sys.executable, str(validator), claim_id, str(root)), validator.parent, (validator,))
    return ClaimExecution(DegrProgram(spec, source_hash), independent, files, DegrExternalValidator(root, spec))
