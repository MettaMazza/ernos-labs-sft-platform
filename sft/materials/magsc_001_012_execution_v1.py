"""Official execution assembly for Materials MAGSC-001--007."""
import json
import sys

from sft.engine import ExternalCommandValidator
from sft.engine.source import build_source_manifest
from sft.materials.magsc_001_012_external_v1 import MANIFEST, REGISTRY, VECTOR, MagscExternalValidator
from sft.materials.magsc_001_012_laws_v1 import SPECS, MagscProgram
...
def build_execution(root, claim_id, execution_file):
    ...
    fixed = (root / "sft/materials/magsc_001_012_laws_v1.py", root / "sft/materials/magsc_001_012_external_v1.py", root / "sft/materials/magsc_001_012_execution_v1.py", root / "sft/physics/structural_constants.py", root / REGISTRY, root / MANIFEST, root / VECTOR, execution_file)
    ...
    validator = root / "generated/materials/magsc_001_012_validator_v1.py"
    independent = ExternalCommandValidator("sft-materials-magsc-001-012-independent-python/1", (sys.executable, str(validator), claim_id, str(root)), validator.parent, (validator,))
    return ClaimExecution(MagscProgram(spec, source_hash), independent, files, MagscExternalValidator(root, spec))
