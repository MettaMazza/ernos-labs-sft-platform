...
def experiment_registration(spec):
    ...
    return {
        ...
        "expected_label": f"complete-quantum-valid-{number}-replay-retained",
        "registry": REGISTRY,
...
def program_document(spec):
    ...
    return {
        ...
        "instructions": [
            ...
            {"opcode": "label", "destination": "prediction", "arguments": ["valid-replay", f"complete-quantum-valid-{number}-replay-retained"]},
