"""Official frozen-engine binding for the inflation-growth terminal law."""
...
from sft.physics.inflation_growth_terminal_law_v1 import CLAIM_ID, SPEC
...
def build_execution(root: Path, execution_file: Path) -> ClaimExecution:
    source_files = (
        ...
        root / "sft/physics/inflation_growth_terminal_execution_v1.py",
    ...
    validator = root / "generated/physics/inflation_growth_terminal_validator_v1.py"
    return ClaimExecution(
        program=StructuralPhysicsProgram(SPEC, source_hash),
        independent_validator=ExternalCommandValidator(
            "sft-physics-inflation-growth-independent-python/1",
