...
from sft.physics.stellar_nuclear_collapse_terminal_law_v1 import CLAIM_ID, SPEC
...
def build_execution(root: Path, execution_file: Path):
    files = (
        ...
        root / "sft/physics/stellar_nuclear_collapse_terminal_execution_v1.py",
    ...
    validator = root / "generated/physics/stellar_nuclear_collapse_terminal_validator_v1.py"
    return ClaimExecution(
        StructuralPhysicsProgram(SPEC, source_hash),
        ExternalCommandValidator(
            "sft-physics-stellar-nuclear-collapse-independent-python/1",
