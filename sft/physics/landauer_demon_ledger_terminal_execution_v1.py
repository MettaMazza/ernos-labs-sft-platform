"""Official frozen-engine binding for the erasure/demon ledger."""
...
from sft.physics.landauer_demon_ledger_terminal_law_v1 import CLAIM_ID, SPEC
...
def build_execution(root: Path, execution_file: Path) -> ClaimExecution:
    source_files = (
        ...
        root / "sft/physics/landauer_demon_ledger_terminal_execution_v1.py",
    ...
    validator = root / "generated/physics/landauer_demon_ledger_terminal_validator_v1.py"
    return ClaimExecution(
        program=StructuralPhysicsProgram(SPEC, source_hash),
        independent_validator=ExternalCommandValidator(
            "sft-physics-landauer-demon-independent-python/1",
