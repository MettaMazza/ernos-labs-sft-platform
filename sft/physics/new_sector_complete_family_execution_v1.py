"""Execution builder for the complete new-sector formal family."""
...
from sft.physics.new_sector_complete_family_law_v1 import SPECS
...
def build_execution(root: Path, claim_id: str, execution_file: Path) -> ClaimExecution:
    ...
    fixed = (
        ...
        root / "sft/physics/new_sector_complete_family_execution_v1.py",
    ...
    validator = root / "generated/physics/new_sector_complete_family_validator_v1.py"
    return ClaimExecution(
        StructuralPhysicsProgram(spec, source_hash),
        ExternalCommandValidator(
            "sft-physics-new-sector-complete-family-independent-python/1",
