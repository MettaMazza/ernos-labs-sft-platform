...
from sft.physics.criticality_universality_turbulence_terminal_law_v1 import CLAIM_ID, SPEC
...
def build_execution(root: Path, execution_file: Path):
    files = (
        ...
        root / "sft/physics/criticality_universality_turbulence_terminal_execution_v1.py",
    ...
    validator = root / "generated/physics/criticality_universality_turbulence_terminal_validator_v1.py"
    return ClaimExecution(
        StructuralPhysicsProgram(SPEC, source_hash),
        ExternalCommandValidator(
            "sft-physics-criticality-universality-turbulence-independent-python/1",
