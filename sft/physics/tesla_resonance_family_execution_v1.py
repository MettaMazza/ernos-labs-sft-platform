"""Execution builder for the formal Tesla-resonance return family."""
...
def build_execution(root: Path, claim_id: str, execution_file: Path) -> ClaimExecution:
    ...
    fixed = (
        ...
        root / "sft/physics/tesla_resonance_family_execution_v1.py",
    ...
    validator = root / "generated/physics/tesla_resonance_family_validator_v1.py"
    return ClaimExecution(
        StructuralPhysicsProgram(spec, source_hash),
        ExternalCommandValidator(
            "sft-physics-tesla-resonance-family-independent-python/1",
