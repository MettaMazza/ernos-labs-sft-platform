"""Execution bindings for complete HAND-001--006 family."""
import json
import sys
...
from sft.information_science.hand_001_006_external_v1 import (
    REGISTRY,
    VECTOR,
    HandObservationValidator,
)
from sft.information_science.hand_001_006_laws_v1 import HandProgram, SPECS
...
def build_execution(root: Path, claim_id: str, execution_file: Path):
    ...
    source_files = [
        ...
        root / "sft/information_science/hand_001_006_laws_v1.py",
        root / "sft/information_science/hand_001_006_external_v1.py",
        root / "sft/information_science/hand_001_006_execution_v1.py",
        root / REGISTRY,
        root / VECTOR,
        root / "census/information_science_discipline_current_reconciliation_v19.json",
        execution_file,
    ]
    ...
    validator = root / "generated/information_science/hand_001_006_validator_v1.py"
    independent = ExternalCommandValidator(
        "sft-information-science-hand-001-006-independent-python/1",
        (sys.executable, str(validator), claim_id, str(root)),
        validator.parent,
        (validator,),
    )
    return ClaimExecution(
        HandProgram(spec, source_hash),
        independent,
        source_files,
        HandObservationValidator(root, spec),
    )
