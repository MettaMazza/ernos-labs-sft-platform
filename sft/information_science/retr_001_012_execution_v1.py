"""Execution bindings for complete RETR-001--012 family."""
import json
import sys
...
from sft.information_science.retr_001_012_external_v1 import (
    REGISTRY,
    VECTOR,
    RetrObservationValidator,
)
from sft.information_science.retr_001_012_laws_v1 import RetrProgram, SPECS
...
def build_execution(root: Path, claim_id: str, execution_file: Path):
    ...
    source_files = [
        ...
        root / "sft/information_science/retr_001_012_laws_v1.py",
        root / "sft/information_science/retr_001_012_external_v1.py",
        root / "sft/information_science/retr_001_012_execution_v1.py",
        root / REGISTRY,
        root / VECTOR,
        execution_file,
    ]
    ...
    validator = root / "generated/information_science/retr_001_012_validator_v1.py"
    independent = ExternalCommandValidator(
        "sft-information-science-retr-001-012-independent-python/1",
        (sys.executable, str(validator), claim_id, str(root)),
        validator.parent,
        (validator,),
    )
    return ClaimExecution(
        RetrProgram(spec, source_hash),
        independent,
        source_files,
        RetrObservationValidator(root, spec),
    )
