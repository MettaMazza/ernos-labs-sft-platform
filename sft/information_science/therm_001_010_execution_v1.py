"""Execution bindings for complete THERM-001--010 family."""
import json
import sys
...
from sft.information_science.therm_001_010_external_v1 import (
    REGISTRY,
    VECTOR,
    ThermObservationValidator,
)
from sft.information_science.therm_001_010_laws_v1 import ThermProgram, SPECS
...
def build_execution(root: Path, claim_id: str, execution_file: Path):
    ...
    source_files = [
        ...
        root / "sft/information_science/therm_001_010_laws_v1.py",
        root / "sft/information_science/therm_001_010_external_v1.py",
        root / "sft/information_science/therm_001_010_execution_v1.py",
        root / REGISTRY,
        root / VECTOR,
        execution_file,
    ]
    ...
    validator = root / "generated/information_science/therm_001_010_validator_v1.py"
    independent = ExternalCommandValidator(
        "sft-information-science-therm-001-010-independent-python/1",
        (sys.executable, str(validator), claim_id, str(root)),
        validator.parent,
        (validator,),
    )
    return ClaimExecution(
        ThermProgram(spec, source_hash),
        independent,
        source_files,
        ThermObservationValidator(root, spec),
    )
