"""Execution bindings for complete CHAN-001--018 family."""
import json
import sys
...
from sft.information_science.chan_001_018_external_v1 import (
    REGISTRY,
    VECTOR,
    ChannelObservationValidator,
)
from sft.information_science.chan_001_018_laws_v1 import ChannelProgram, SPECS
...
def build_execution(root: Path, claim_id: str, execution_file: Path):
    ...
    source_files = [
        ...
        root / "sft/information_science/chan_001_018_laws_v1.py",
        root / "sft/information_science/chan_001_018_external_v1.py",
        root / "sft/information_science/chan_001_018_execution_v1.py",
        root / REGISTRY,
        root / VECTOR,
        execution_file,
    ]
    ...
    validator = root / "generated/information_science/chan_001_018_validator_v1.py"
    independent = ExternalCommandValidator(
        "sft-information-science-chan-001-018-independent-python/1",
        (sys.executable, str(validator), claim_id, str(root)),
        validator.parent,
        (validator,),
    )
    return ClaimExecution(
        ChannelProgram(spec, source_hash),
        independent,
        source_files,
        ChannelObservationValidator(root, spec),
    )
