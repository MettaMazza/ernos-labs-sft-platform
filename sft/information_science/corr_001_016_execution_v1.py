"""Execution bindings for complete CORR-001--016 family."""
import json
import sys
...
from sft.information_science.corr_001_016_external_v1 import (
    REGISTRY,
    VECTOR,
    CorrObservationValidator,
)
from sft.information_science.corr_001_016_laws_v1 import CorrProgram, SPECS
...
def build_execution(root: Path, claim_id: str, execution_file: Path):
    ...
    source_files = [
        ...
        root / "sft/information_science/corr_001_016_laws_v1.py",
        root / "sft/information_science/corr_001_016_external_v1.py",
        root / "sft/information_science/corr_001_016_execution_v1.py",
        root / REGISTRY,
        root / VECTOR,
        execution_file,
    ]
    ...
    validator = root / "generated/information_science/corr_001_016_validator_v1.py"
    independent = ExternalCommandValidator(
        "sft-information-science-corr-001-016-independent-python/1",
        (sys.executable, str(validator), claim_id, str(root)),
        validator.parent,
        (validator,),
    )
    return ClaimExecution(
        CorrProgram(spec, source_hash),
        independent,
        source_files,
        CorrObservationValidator(root, spec),
    )
