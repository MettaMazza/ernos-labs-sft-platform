...
REGISTRY = "census/information_science_hand_001_006_target_registry_v1.json"
REGISTRY_HASH = "sha256:dd3fa5bd35613fc63eacf23cf03d6188a641aea8ea5a8c81015eb8de656ade74"
VECTOR = "experiments/external_sources/information_science/hand_001_006_observation_vector_v1.json"
VECTOR_HASH = "sha256:23b5ae95f7557566d925394e712593e70b1ba7bb8a57ce36a2424578fca693ca"
...
def registration(spec):
    ...
    return {
        "experiment_id": f"SFT-EXP-INFO-HAND-{number}-V1",
        "claim_id": spec.claim_id,
        "target_id": f"INFO-HAND-{number}-EXACT-OBSERVATION-V1",
        "expected_label": f"complete-hand-{number}-observation-retained",
        "registry": REGISTRY,
        "falsification_condition": "Reject if the value-free registry, frozen 256-receipt predecessor, complete one-owner dependency and handoff vector, exact observation, candidate survivor, source identity, seal, custody record or independent reconstruction is missing, stale, changed, duplicated, ownerless, selectively omitted or opened out of order.",
    }
...
def document(spec):
    ...
    return {
        ...
        "program_id": f"SFT-EXP-INFO-HAND-{number}-V1-prediction",
        "instructions": [
            {"opcode": "input", "destination": "premise", "arguments": ["registered-premise"]},
            {"opcode": "label", "destination": "prediction", "arguments": ["hand-observation", f"complete-hand-{number}-observation-retained"]},
...
class HandObservationValidator:
    ...
    def validate(self, sealed):
        ...
        isolation = seal_isolation_certificate(unsealed_isolation_certificate(
            ...
            comparison_implementation_identity_hash=sha256_identity(("information-science-hand-observer-v1", self.spec.claim_id)),
        ...
        measurements = (
            ...
            "the frozen 256-receipt predecessor, six handoff obligations, one-owner dependency graph, complete boundary records and implementation-distinct reconstruction supply the observation; no copied law, duplicate owner, silent conventional import, rewritten receipt or edited authority enters",
        )
        payload = {
