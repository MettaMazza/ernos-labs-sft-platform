"""Execution bindings for complete VALID-001--012 family."""
import json
import sys
...
from sft.information_science.valid_001_012_external_v1 import (
    REGISTRY,
    VECTOR,
    ValidObservationValidator,
)
from sft.information_science.valid_001_012_laws_v1 import ValidProgram, SPECS
...
def build_execution(root: Path, claim_id: str, execution_file: Path):
    ...
    source_files = [
        ...
        root / "sft/information_science/valid_001_012_laws_v1.py",
        root / "sft/information_science/valid_001_012_external_v1.py",
        root / "sft/information_science/valid_001_012_execution_v1.py",
        root / REGISTRY,
        root / VECTOR,
        root / "census/information_science_discipline_current_reconciliation_v18.json",
        execution_file,
    ]
    ...
    validator = root / "generated/information_science/valid_001_012_validator_v1.py"
    independent = ExternalCommandValidator(
        "sft-information-science-valid-001-012-independent-python/1",
        (sys.executable, str(validator), claim_id, str(root)),
        validator.parent,
        (validator,),
    )
    return ClaimExecution(
        ValidProgram(spec, source_hash),
        independent,
        source_files,
        ValidObservationValidator(root, spec),
    )
