"""Execution bindings for complete SEM-001--012 family."""
import json
import sys
...
from sft.information_science.sem_001_012_external_v1 import (
    REGISTRY,
    VECTOR,
    SemObservationValidator,
)
from sft.information_science.sem_001_012_laws_v1 import SemProgram, SPECS
...
def build_execution(root: Path, claim_id: str, execution_file: Path):
    ...
    source_files = [
        ...
        root / "sft/information_science/sem_001_012_laws_v1.py",
        root / "sft/information_science/sem_001_012_external_v1.py",
        root / "sft/information_science/sem_001_012_execution_v1.py",
        root / REGISTRY,
        root / VECTOR,
        execution_file,
    ]
    ...
    validator = root / "generated/information_science/sem_001_012_validator_v1.py"
    independent = ExternalCommandValidator(
        "sft-information-science-sem-001-012-independent-python/1",
        (sys.executable, str(validator), claim_id, str(root)),
        validator.parent,
        (validator,),
    )
    return ClaimExecution(
        SemProgram(spec, source_hash),
        independent,
        source_files,
        SemObservationValidator(root, spec),
    )
