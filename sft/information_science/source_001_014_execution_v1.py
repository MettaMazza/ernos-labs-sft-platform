"""Execution bindings for complete SOURCE-001--014 family."""
import json
import sys
...
from sft.information_science.source_001_014_external_v1 import (
    REGISTRY,
    VECTOR,
    SourceObservationValidator,
)
from sft.information_science.source_001_014_laws_v1 import SourceProgram, SPECS
...
def build_execution(root: Path, claim_id: str, execution_file: Path):
    ...
    source_files = [
        ...
        root / "sft/information_science/source_001_014_laws_v1.py",
        root / "sft/information_science/source_001_014_external_v1.py",
        root / "sft/information_science/source_001_014_execution_v1.py",
        root / REGISTRY,
        root / VECTOR,
        execution_file,
    ]
    ...
    validator = root / "generated/information_science/source_001_014_validator_v1.py"
    independent = ExternalCommandValidator(
        "sft-information-science-source-001-014-independent-python/1",
        (sys.executable, str(validator), claim_id, str(root)),
        validator.parent,
        (validator,),
    )
    return ClaimExecution(
        SourceProgram(spec, source_hash),
        independent,
        source_files,
        SourceObservationValidator(root, spec),
    )
