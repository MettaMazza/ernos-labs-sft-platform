#!/usr/bin/env python3
"""Render the E04 2.0.0 adult guide from versioned Markdown."""
...
OUTPUT = ROOT / "output/pdf/edu/SFT-EDU-E04-LOOK-AGAIN-HOW-WE-CHECK/2.0.0/SFT-E04-Adult-Guide-v2.0.0.pdf"
...
def footer(pdf_canvas, doc) -> None:
    ...
    pdf_canvas.drawString(18 * mm, 9 * mm, "E04 Look Again: How We Check · Adult Guide · review 2.0.0")
...
def main() -> None:
    ...
    doc = SimpleDocTemplate(str(OUTPUT), pagesize=A4, leftMargin=20 * mm, rightMargin=20 * mm,
                            ...
                            title="Adult Guide — E04 Look Again: How We Check", author="Maria Smith",
