#!/usr/bin/env python3
"""Render the E02 2.0.0 adult guide from its versioned Markdown source."""
...
OUTPUT = ROOT / "output/pdf/edu/SFT-EDU-E02-ONE-WHOLE-MANY-PARTS/2.0.0/SFT-E02-Adult-Guide-v2.0.0.pdf"
...
def footer(pdf_canvas, doc) -> None:
    ...
    pdf_canvas.drawString(18 * mm, 9 * mm, "E02 One Whole, Many Parts · Adult Guide · review 2.0.0")
...
def main() -> None:
    ...
    doc = SimpleDocTemplate(str(OUTPUT), pagesize=A4, leftMargin=20 * mm, rightMargin=20 * mm,
                            ...
                            title="Adult Guide — E02 One Whole, Many Parts", author="Maria Smith",
