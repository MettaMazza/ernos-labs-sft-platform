...
Mira, Sol and Tavi remain the main trio. E02 introduces exactly one new guest:
...
### Pages 28–29 — delayed retrieval

Answer B: Sol touched one tile twice. If the child first chooses A or C, say,
...
technology and include a replay control. Mira, Sol and Tavi remain visible; Pax
is the sole new Level Two guest. The book-page bridge remains available after a
correct answer. Optional codes unlock only character moments, alternate replay
arrangements or an E03 preview.
