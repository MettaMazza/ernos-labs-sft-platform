...
Scope: E01 companion adventure review 1.4.1
Remote hosting status: not authorised and not ready

The production build and seven application/content tests pass with Node.js 22.
...
2. repeat the production build, seven automated tests and full device play test;
