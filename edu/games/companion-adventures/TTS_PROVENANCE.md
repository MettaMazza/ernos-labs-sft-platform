# Level One, Level Two and Level Three narration provenance
...
`narration-manifest.json`, `narration-manifest-e02.json` and
`narration-manifest-e03.json`. Kokoro supplies voices only; it supplies no premise,
...
- output: 36 E01 MP3 files at 24 kHz in `public/audio/e01-v1.6.0/`
- output: 28 E02 MP3 files at 24 kHz in `public/audio/e02-v1.0.0/`
- output: 28 E03 MP3 files at 24 kHz in `public/audio/e03-v1.0.0/`
...
- detailed model, voice, manifest and output hashes:
  ...
  `public/audio/e02-v1.0.0/generation-receipt.json` and
  `public/audio/e03-v1.0.0/generation-receipt.json`
...
lines, so all three levels remain offline-capable and practical on phones and tablets.
...
`bm_george`; and E03 guest Vee uses `af_heart`. This mapping is versioned
