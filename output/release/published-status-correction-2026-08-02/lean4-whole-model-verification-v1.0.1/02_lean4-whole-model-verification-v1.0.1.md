...
**Correction predecessor:** Version 1.0.0 at `publications/lean4_verification/SMITHIAN_FOLD_THEORY_LEAN4_WHOLE_MODEL_VERIFICATION_PAPER_V1_0.md`  
**Correction predecessor DOI:** [10.5281/zenodo.21760451](https://doi.org/10.5281/zenodo.21760451)  
**DOI:** [10.5281/zenodo.21761665](https://doi.org/10.5281/zenodo.21761665)  
...
> It is published open access at [10.5281/zenodo.21761665](https://doi.org/10.5281/zenodo.21761665) through
> Zenodo's new-version route after [10.5281/zenodo.21760451](https://doi.org/10.5281/zenodo.21760451)
...
The compiled verifier then reads the complete ordered model census and execution manifest as data. It checks 2,777 live claims across 17 branches, 898,902 candidate records, 898,902 decision records and 11,108 controls. It verifies identity, source custody, dependency closure, candidate completeness, decision coverage, exactly one survivor, minimality, named-form uniqueness, controls, empirical boundary, certificate binding and admitted-receipt status for every claim. The final result is `PASS` with 0 issue. The machine report is `generated/lean4_validation/reports/whole_model_validation.json` with identity `sha256:6b6a5a9a9a0b74687a6f97fb3b4fcc7455968e35c82395290837cda60d7501cf`.

The result strengthens SFT's formal-coherence, exhaustiveness, provenance and cross-branch consistency case. It does not convert the remaining 2,776 scientific statements into native Lean propositions, replace empirical tests, or establish superiority to every rival theory. Those boundaries are part of the verified claim discipline rather than exceptions to it. Lawful criticism, falsification and versioned extension remain open, and empirical and publication status remain distinct.
...
3. **Complete current-census audit.** All 2,777 ordered claims receive proof-bearing accepted gate certificates after 898,902 candidates, the same number of decisions and 11,108 controls are checked.
4. **Complete branch surface.** All 17 registered branches reconcile with no omitted census claim and no reported issue.
...
| Publication status | Version 1.0.1 is published open access at [10.5281/zenodo.21761665](https://doi.org/10.5281/zenodo.21761665) in the existing Zenodo concept DOI lineage. |
...
- census: `sha256:f3f540f77a9b677bf7ddb9f5c6ea1ea41f08e57bb07163e25f385fd4d1dcde71`;
- execution manifest: `sha256:517fd288f4484f43fdc0343b17fcabd06ea9e12c977a4512d4a891dd038fce41`.
...
The verifier also preserves historical lineages without counting them as current authority: 200 prior receipt lineages and 200 prior certificate-source lineages were encountered. It checked 80 custom decision artifacts. Two uncensused nonmodel package directories were reported rather than silently absorbed: an empty future package and a rejected adverse package whose rejected receipt remains preserved. Neither is counted among the 2,777 accepted claims.

### 5.2 Complete result

| Quantity | Verified result |
|---|---:|
| Claims in ordered census | 2,777 |
| Accepted proof-bearing gates | 2,777 |
...
| Branch | Claims |
|---|---:|
| `astronomy_cosmology` | 77 |
| `biology` | 82 |
| `chemistry` | 281 |
| `computation` | 375 |
| `consciousness_cognitive_science` | 77 |
| `cross_branch_synthesis` | 12 |
| `earth_environment` | 75 |
| `engineering_translation` | 80 |
| `foundation` | 16 |
| `information_science` | 262 |
| `materials` | 289 |
| `mathematics` | 341 |
| `medicine` | 76 |
| `physics` | 368 |
| `quantum_computation` | 290 |
| `social_collective` | 4 |
| `social_collective_systems` | 72 |
...
ELAN_HOME="$PWD/.elan" PATH="$PWD/.elan/bin:$PATH"   .lake/build/bin/sft-verify ../.. reports/whole_model_validation.json
```

The checked-in `./run_validation.sh` performs the same build-and-run route. A successful run must exit zero and reproduce a report whose scientific counts, input hashes and issue-free status match this paper. The report file's byte hash can differ only if non-scientific serialization metadata changes; in this version the exact expected identity is `sha256:6b6a5a9a9a0b74687a6f97fb3b4fcc7455968e35c82395290837cda60d7501cf`.

### Verification-source identities

| Source | SHA-256 |
|---|---|
| `generated/lean4_validation/lean-toolchain` | `sha256:90f5a018ecbd1ad55afee82b7677bf492958f1786fcbf76c1fa145742f53d432` |
| `generated/lean4_validation/lakefile.toml` | `sha256:aefcc07b064480f8aa1b130e5167c911aff5694ebc7a021052d9942a04c41fee` |
| `generated/lean4_validation/Main.lean` | `sha256:d116cbaf7db3d784db90b67a8b42611ffd57c4bf75bdf7160701dc068ee05577` |
| `generated/lean4_validation/SFTValidation.lean` | `sha256:ceb0357e40a0e5bdd229eafa34bf1083759ae2fd8ace1668daacf18c82d0e683` |
| `generated/lean4_validation/SFTValidation/Root.lean` | `sha256:937a9cbf0053f36117171dba65577034641e3165562822784a4013178463132f` |
| `generated/lean4_validation/SFTValidation/Gates.lean` | `sha256:74c956a67786bb7a846cf6ee58616fcfb3ccbc00b719d2e7f34622d2a80691da` |
| `generated/lean4_validation/SFTValidation/JsonUtil.lean` | `sha256:d648cf8f7c4ae386e1b170764fc8f93970bb91a9d75d89143c6fef812ba30f06` |
| `generated/lean4_validation/SFTValidation/Verifier.lean` | `sha256:ce7b77b3b49af982aecc2a753905b9afa0a80762e3434a78cd6f677f33a4db0b` |
| `generated/lean4_validation/source_binding_probe.py` | `sha256:f36264cbe615657f2d146097b54e9f817f0b52f67f4820d899b35566e0b25662` |
| `generated/lean4_validation/run_validation.sh` | `sha256:8d658cbb7f90dcb824d789bdb9661e95ed0e09ccd4b55cd378110d8b797e28ac` |
...
### Premise-free operational root theorem

**Claim ID:** `SFT-ROOT-THERE-IS-NO-NOTHING`  
**Exact statement:** No admissible operational statement, denial, record, proof object or derivational object is nothing: absence presents no counterexample, while every presented counterexample is an occurrence.  
**Dependency route:** Root; no preceding dependency  
**Candidate generator:** Partition every purported operational counterexample by whether it emits an identifiable presentation at the proof boundary.  
**Grammar boundary:** All operational statements, denials, records and proof challenges, independent of their internal length or notation.  
**Complete census:** 2 candidates; 1 unique survivor; 4 controls  
**Survivor:** `presented-occurrence`  
**Exact result:** presented-occurrence is the unique surviving operational class  
**Closure:** `depth_independent`; minimality `True`; named-shape uniqueness `True`  
**External status:** `independently_replicated`  
**Engine receipt:** `sha256:711864171e4d3a2f2734f0c2890965bcd81a0228349538751a3c80699c27d669` at `receipts/engine/model_admitted/SFT-ROOT-THERE-IS-NO-NOTHING-711864171e4d3a2f.json`

| Control | Passed | Expected | Observed |
|---|---|---|---|
| false_premise | True | reject because no counterexample identity or trace exists | unpresented-absence is not admissible as a counterexample |
| tampered_source | True | reject source drift before enumeration | the altered identity differs from the registered identity |
| tampered_artifact | True | reject because forcing no longer has a unique survivor | the tampered survivor set contains both named classes |
| boundary | True | refuse the broadened claim because it supplies no checkable object | the theorem remains scoped to admissible operational objects |
